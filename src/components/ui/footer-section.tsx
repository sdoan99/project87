...
function Footerdemo() {
  ...
  return (
    <footer className='relative border-t border-gray-800 bg-gray-900 text-foreground transition-colors duration-300'>
          ...
          <div className='relative'>
            ...
            <form className='relative'>
              <Input
                ...
                className='pr-12 backdrop-blur-sm bg-gray-800/50'
              />
              <Button
                type='submit'
                size='icon'
