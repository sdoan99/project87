                    ...
                    <div className='flex gap-3'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          A comprehensive financial platform offering trading tools, educational
                          resources, live market insights, and real facts.
                        </p>
                      </div>
                    </div>
                  </TooltipContent>
                  ...
                  <TooltipContent className='dark py-3'>
                    <div className='flex gap-3'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Prices and fees are often obscured, requiring downloads or signups to
                          access basic info, what else are they hiding. Additionally, Trades can be
                          delayed by months with congressmen and institutional funds are not
                          required to disclose their transactions for up to 45+ days or just 4 times
                          a year.
                        </p>
                      </div>
                    </div>
                  ...
                  <TooltipContent className='dark py-3'>
                    <div className='flex gap-3'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          Discord, Substack, Twitter, TikTok, YouTube -- financial tips, courses,
                          and stock bets are everywhere. Whether it’s hype-driven marketing, Pump &
                          Dump exit liquidity, our platform brings transparency and helps you
                          decide.
                        </p>
                      </div>
                    </div>
                  ...
                  <TooltipContent className='dark py-3'>
                    <div className='flex gap-3'>
                      ...
                      <div className='space-y-1'>
                        ...
                        <p className='text-xs text-muted-foreground'>
                          WaPo, NYT, FT, WSJ, Economist, CNBC -- modern media runs on attention, ad
                          dollars, and private funding. Whether it’s biased or agenda-driven is up
                          for debate, but relying on it for financial news can be very bad news.
                        </p>
                      </div>
                    </div>
                  </TooltipContent>
