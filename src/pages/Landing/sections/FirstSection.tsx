    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col items-center">
      ...
      <div className="w-full bg-transparent rounded-2xl shadow-xl p-8 md:p-12 grid grid-rows-[auto_1fr] gap-12 transition-colors duration-300 hover:bg-gray-800">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          {/* Groups Feature */}
          <div className="flex flex-col items-start feature-group" data-image-target="strategy-sort">
            <div className="bg-blue-900/50 p-3 rounded-lg mb-4">
              <Grid className="w-8 h-8 text-blue-400" />
            </div>
            <h2 className="text-2xl font-semibold mb-2 text-white">
              Open sourced and{' '}
              <span className="text-blue-400">Historically tested</span> PnL to see what strategies are real and what is social media hype
            </h2>
          </div>
          ...
          <div className="flex flex-col items-start feature-group" data-image-target="key-stats">
            ...
            <h2 className="text-2xl font-semibold mb-2 text-white">
              Save <span className="text-blue-400">time and money</span> with access to transparent research, backtesting, and verified reviews
            </h2>
          </div>
        </div>
