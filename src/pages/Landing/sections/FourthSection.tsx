  ...
  const slides = [
    {
      ...
      description:
        'Earn Token Rewards for Education Milestones & Growing with the Platform + other Community Contributions.',
    ...
    },
    {
      ...
      description:
        'Generate insights and expand the collective knowledge base. Utilize growth loops to foster community and encourage participation in meaningful discussions.',
      buttonText: 'Sign Up',
    ...
    },
    {
      ...
      description:
        'Promote the mission of building financial literacy, wellness, education, and onboarding new participants around the world.',
          ...
          {slides.map((_, index) => (
            <button
              ...
              className={`w-2 h-2 rounded-full transition-all duration-300 ${
                currentSlide === index ? 'bg-white w-6' : 'bg-gray-600 hover:bg-gray-500'
              }`}
