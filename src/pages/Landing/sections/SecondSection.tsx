        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4 text-gray-400">
              <p>Unlock opportunities across stocks, crypto, and alternative investments with real-time data and expert-backed insights.</p>
                
              <p>Our platform keeps you ahead of trends, so you can confidently navigate dynamic markets.</p>
            </div>
          </div>
      ...
      <div className="mt-16 w-full bg-transparent rounded-2xl shadow-xl p-8 md:p-12 transition-colors duration-300 hover:bg-gray-800">
        <div className="flex flex-col md:flex-row-reverse justify-between items-center gap-12">
          ...
          <div className="max-w-md">
            ...
            <div className="space-y-4 text-gray-400">
              <p>Stay ahead and leverage market insights with signals, market analysis, and performance tracking. </p>
              <p>Our platform ensures you never miss an opportunity by delivering accurate insights tailored to every risk profile and strategy.</p>
            </div>
          </div>
