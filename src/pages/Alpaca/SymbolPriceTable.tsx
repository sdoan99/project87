...
export function SymbolPriceTable({ symbolInput, setSymbolInput, price, symbolData }: SymbolPriceTableProps) {
  return (
    <>
      <div className="flex justify-center items-center mt-16">
        <table className="border border-black min-w-[220px]">
          <tbody>
            <tr>
              <td className="border border-black px-4 py-2 font-semibold text-sm text-left">SYMBOL</td>
