const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ['./codeMirrorModule-DpJ-EmBQ.js', '../codeMirrorModule.C3UTv-Ge.css'])
) => i.map(i => d[i]);
var Q0 = Object.defineProperty;
var X0 = (t, e, n) =>
  e in t ? Q0(t, e, { enumerable: !0, configurable: !0, writable: !0, value: n }) : (t[e] = n);
...
function J0() {
  ...
  var w = {
    ...
    S = {};
  function E(L, H, fe) {
    (this.props = L), (this.context = H), (this.refs = S), (this.updater = fe || w);
  }
  ...
  function B(L, H, fe) {
    var ue,
      ...
      pe = null;
    if (H != null)
      for (ue in (H.ref !== void 0 && (pe = H.ref), H.key !== void 0 && (ge = '' + H.key), H))
        D.call(H, ue) && !U.hasOwnProperty(ue) && (ve[ue] = H[ue]);
    var Se = arguments.length - 2;
    if (Se === 1) ve.children = fe;
    else if (1 < Se) {
      for (var Te = Array(Se), ct = 0; ct < Se; ct++) Te[ct] = arguments[ct + 2];
      ve.children = Te;
    }
    if (L && L.defaultProps)
  ...
  function j(L, H) {
    return { $$typeof: t, type: L.type, key: H, ref: L.ref, props: L.props, _owner: L._owner };
  }
  function Q(L) {
  ...
  var z = /\/+/g;
  function J(L, H) {
    return typeof L == 'object' && L !== null && L.key != null ? W('' + L.key) : H.toString(36);
  }
  ...
  var ye = { current: null },
    G = { transition: null },
    se = { ReactCurrentDispatcher: ye, ReactCurrentBatchConfig: G, ReactCurrentOwner: F };
  function Z() {
...
function s1() {
  ...
  t && document.body.classList.remove(t), document.body.classList.add(e), _r.setString('theme', e);
      ...
      (function (t) {
            ...
            e: for (var L = 0, H = G.length, fe = H >>> 1; L < fe; ) {
              ...
              if (0 > o(ve, Z))
                ge < H && 0 > o(pe, ve)
                  ? ((G[L] = pe), (G[ge] = Z), (L = ge))
                  : ((G[L] = ve), (G[ue] = Z), (L = ue));
              else if (ge < H && 0 > o(pe, Z)) (G[L] = pe), (G[ge] = Z), (L = ge);
              else break e;
            }
          }
          return se;
        ...
        function O(G) {
          for (var se = n(p); se !== null; ) {
            ...
            else if (se.startTime <= G) s(p), (se.sortIndex = se.expirationTime), e(d, se);
            else break;
            se = n(p);
          }
        }
        ...
        function D(G, se) {
          ...
          var Z = m;
          try {
            for (O(se), v = n(d); v !== null && (!(v.expirationTime > se) || (G && !W())); ) {
              var L = v.callback;
              if (typeof L == 'function') {
                (v.callback = null), (m = v.priorityLevel);
                var H = L(v.expirationTime <= se);
                (se = t.unstable_now()),
                  typeof H == 'function' ? (v.callback = H) : v === n(d) && s(d),
                  O(se);
              } else s(d);
              v = n(d);
            }
          ...
          (t.unstable_scheduleCallback = function (G, se, Z) {
            ...
            return (
              ...
              Z > L
                ? ((G.sortIndex = Z),
                  e(p, G),
                  n(d) === null && G === n(p) && (S ? (T(B), (B = -1)) : (S = !0), ye(R, Z - L)))
...
function a1() {
  ...
  var u = !(
    ...
    v = {};
  function m(r) {
    return d.call(v, r) ? !0 : d.call(y, r) ? !1 : p.test(r) ? (v[r] = !0) : ((y[r] = !0), !1);
  }
  function w(r, i, a, f) {
...
` + h[k].replace(' at new ', ' at ');
  ...
  function pw(r, i) {
    for (
      var a = r.suspendedLanes, f = r.pingedLanes, h = r.expirationTimes, g = r.pendingLanes;
      0 < g;
      ...
      var k = 31 - Qt(g),
        b = 1 << k,
        N = h[k];
      N === -1 ? (!(b & a) || b & f) && (h[k] = hw(b, i)) : N <= i && (r.expiredLanes |= b),
        (g &= ~b);
    }
  }
  function Aa(r) {
  ...
  function yw(r, i, a, f, h) {
    switch (i) {
      ...
      case 'gotpointercapture':
        return (g = h.pointerId), Js.set(g, Ys(Js.get(g) || null, r, i, a, f, h)), !0;
    }
    return !1;
  }
  function pd(r) {
  ...
  function Zs(r, i) {
    r.blockedOn === i &&
      ((r.blockedOn = null),
      Ma || ((Ma = !0), e.unstable_scheduleCallback(e.unstable_NormalPriority, vw)));
  }
  function ei(r) {
    function i(h) {
      return Zs(h, r);
    ...
    if (po) {
      ...
      if (h === null) Ya(r, i, f, mo, a), hd(r, f);
        ...
        for (; h !== null; ) {
          var g = di(h);
          if (
            (g !== null && cd(g), (g = $a(r, i, a, f)), g === null && Ya(r, i, f, mo, a), g === h)
          )
            break;
          h = g;
        }
  ...
  function Lt(r) {
    function i(a, f, h, g, k) {
      ...
      for (var b in r) r.hasOwnProperty(b) && ((a = r[b]), (this[b] = a ? a(g) : g[b]));
      return (
  ...
  function Mw(r) {
    ...
    return i.getModifierState ? i.getModifierState(r) : (r = jw[r]) ? !!i[r] : !1;
  }
  function Ba() {
    return Mw;
  }
  ...
  function Cd(r, i, a, f) {
    Qf(f),
      (i = Eo(i, 'onChange')),
      0 < i.length &&
        ((a = new Ra('onChange', 'change', null, a, f)), r.push({ event: a, listeners: i }));
  }
  var si = null,
    ii = null;
  function Qw(r) {
  ...
  if (u) {
    ...
    if (u) {
      ...
      if (!qa) {
        ...
        Ld.setAttribute('oninput', 'return;'), (qa = typeof Ld.oninput == 'function');
      }
      Ha = qa;
    } else Ha = !1;
  ...
  function Jw(r) {
    if (r === 'selectionchange' || r === 'keyup' || r === 'keydown') return xo(ii);
  }
  function Yw(r, i) {
  ...
  function t0(r) {
    var i = Pd(),
      a = r.focusedElem,
      f = r.selectionRange;
    if (i !== a && a && a.ownerDocument && $d(a.ownerDocument.documentElement, a)) {
      if (f !== null && Va(a)) {
  ...
  var ai =
    ...
    i0 = new Set('cancel close invalid load scroll toggle'.split(' ').concat(ai));
  function Vd(r, i, a) {
        ...
        if (i)
          for (var k = f.length - 1; 0 <= k; k--) {
            var b = f[k],
              N = b.instance,
              $ = b.currentTarget;
            if (((b = b.listener), N !== g && h.isPropagationStopped())) break e;
            Vd(h, b, $), (g = N);
          }
        else
  ...
  function Kd(r, i, a, f) {
    ...
    (a = h.bind(null, i, a, r)),
      (h = void 0),
      !Ta || (i !== 'touchstart' && i !== 'touchmove' && i !== 'wheel') || (h = !0),
      f
        ? h !== void 0
        ...
        if (q !== void 0) {
          ...
          for (var A = $, M; A !== null; ) {
            ...
            if (
              (M.tag === 5 &&
                X !== null &&
                ((M = X), I !== null && ((X = Vs(A, I)), X != null && ne.push(ui(A, X, M)))),
              Ue)
            )
              break;
            A = A.return;
          }
          0 < ne.length && ((q = new Y(q, te, null, a, V)), K.push({ event: q, listeners: ne }));
        }
      }
      if (!(i & 7)) {
        e: {
          if (
            ...
            q && a !== _a && (te = a.relatedTarget || a.fromElement) && (cr(te) || te[mn]))
          )
            break e;
          if (
            (Y || q) &&
            ...
            Y
              ? ((te = a.relatedTarget || a.toElement),
                ...
                (te = te ? cr(te) : null),
                te !== null &&
                  ((Ue = ar(te)), te !== Ue || (te.tag !== 5 && te.tag !== 6)) &&
                  (te = null))
              : ((Y = null), (te = $)),
            Y !== te)
          ) {
            if (
              ...
              (r === 'pointerout' || r === 'pointerover') &&
                ((ne = Sd), (X = 'onPointerLeave'), (I = 'onPointerEnter'), (A = 'pointer')),
              (Ue = Y == null ? q : Kr(Y)),
              (M = te == null ? q : Kr(te)),
            ...
            Y !== null && Qd(K, q, Y, ne, !1), te !== null && Ue !== null && Qd(K, Ue, te, ne, !0);
          }
        }
        e: {
          if (
        ...
        switch (((ie = $ ? Kr($) : window), r)) {
          case 'focusin':
            (Nd(ie) || ie.contentEditable === 'true') && ((Hr = ie), (Wa = $), (li = null));
            break;
          case 'focusout':
            li = Wa = Hr = null;
            break;
        ...
        ce &&
          (_d &&
            ...
            (Ur || ce !== 'onCompositionStart'
              ...
              : ((Rn = V), (Pa = 'value' in Rn ? Rn.value : Rn.textContent), (Ur = !0))),
          (ie = Eo($, ce)),
          0 < ie.length &&
            ((ce = new xd(ce, r, null, a, V)),
            K.push({ event: ce, listeners: ie }),
            oe ? (ce.data = oe) : ((oe = Td(a)), oe !== null && (ce.data = oe)))),
          (oe = qw ? Vw(r, a) : Ww(r, a)) &&
            (($ = Eo($, 'onBeforeInput')),
            0 < $.length &&
...
`
  ...
  function Ao(r) {
    return (
      (r = ((r = r.stateNode) && r.__reactInternalMemoizedMergedChildContext) || Bn),
      (ur = rt.current),
      Ne(rt, r),
      Ne(vt, vt.current),
      !0
  ...
  function ac(r) {
    for (; r === Io; ) (Io = Gr[--Jr]), (Gr[Jr] = null), (jo = Gr[--Jr]), (Gr[Jr] = null);
    for (; r === fr; )
      (fr = $t[--Pt]),
        ($t[Pt] = null),
        (vn = $t[--Pt]),
    ...
    switch (r.tag) {
      case 5:
        ...
        return (
          ...
          i !== null ? ((r.stateNode = i), (It = r), (jt = Fn(i.firstChild)), !0) : !1
        );
      case 6:
        return (
    ...
    if (Ie) {
      ...
      if (i) {
        ...
        if (!sh(r, i)) {
          ...
          i = Fn(a.nextSibling);
          var f = It;
          i && sh(r, i) ? rh(f, a) : ((r.flags = (r.flags & -4097) | 2), (Ie = !1), (It = r));
        }
      } else {
        if (cc(r)) throw Error(n(418));
  ...
  function Mo(r) {
    ...
    if (
      ((i = r.tag !== 3) &&
        !(i = r.tag !== 5) &&
        ((i = r.type), (i = i !== 'head' && i !== 'body' && !tc(r.type, r.memoizedProps))),
      i && (i = jt))
    ) {
  ...
  function ah(r) {
    ...
    function g(I, A, M) {
      return (
        ...
        r
          ? ((M = I.alternate),
            M !== null ? ((M = M.index), M < A ? ((I.flags |= 2), A) : M) : ((I.flags |= 2), A))
          : ((I.flags |= 1048576), A)
      );
    }
    function k(I) {
    ...
    function N(I, A, M, X) {
      ...
      return re === U
        ...
        : A !== null &&
            (A.elementType === re ||
              (typeof re == 'object' && re !== null && re.$$typeof === Ce && lh(re) === A.type))
    ...
    function K(I, A, M) {
      ...
      if (typeof A == 'object' && A !== null) {
        ...
        if (pn(A) || se(A)) return (A = xr(A, I.mode, M, null)), (A.return = I), A;
        Oo(I, A);
      }
      return null;
    }
    ...
    function Y(I, A, M, X, re) {
      ...
      if (typeof X == 'object' && X !== null) {
        switch (X.$$typeof) {
          case D:
            return (I = I.get(X.key === null ? M : X.key) || null), N(A, I, X, re);
          case F:
            return (I = I.get(X.key === null ? M : X.key) || null), $(A, I, X, re);
          case Ce:
            var ie = X._init;
    ...
    function te(I, A, M, X) {
      ...
      for (oe = f(I, oe); ce < M.length; ce++)
        (Je = Y(oe, I, ce, M[ce], X)),
          Je !== null &&
            (r && Je.alternate !== null && oe.delete(Je.key === null ? ce : Je.key),
            (A = g(Je, A, ce)),
            ...
            e: {
              for (var re = M.key, ie = A; ie !== null; ) {
                if (ie.key === re) {
                  if (((re = M.type), re === U)) {
                    if (ie.tag === 7) {
                      a(I, ie.sibling), (A = h(ie, M.props.children)), (A.return = I), (I = A);
                      break e;
                    }
                  } else if (
                    ie.elementType === re ||
              ...
              M.type === U
                ? ((A = xr(M.props.children, I.mode, X, M.key)), (A.return = I), (I = A))
                : ((X = sl(M.type, M.key, M.props, null, I.mode, X)),
                  (X.ref = hi(I, A, M)),
                  (X.return = I),
                  (I = X));
              ...
              for (ie = M.key; A !== null; ) {
                if (A.key === ie)
                  if (
                    ...
                    a(I, A.sibling), (A = h(A, M.children || [])), (A.return = I), (I = A);
                    break e;
                  } else {
                    a(I, A);
                    break;
  ...
  function ts(r, i) {
    (Po = r),
      (dc = es = null),
      (r = r.dependencies),
      r !== null && r.firstContext !== null && (r.lanes & i && (xt = !0), (r.firstContext = null));
  }
  function Rt(r) {
  ...
  function qn(r, i, a) {
    ...
    if (((f = f.shared), we & 2)) {
      var h = f.pending;
      return (
        h === null ? (i.next = i) : ((i.next = h.next), (h.next = i)), (f.pending = i), wn(r, a)
      );
    }
    return (
      (h = f.interleaved),
  ...
  function Do(r, i, a, f) {
    ...
    if (b !== null) {
      ...
      V !== null &&
        ((V = V.updateQueue),
        (b = V.lastBaseUpdate),
        b !== k && (b === null ? (V.firstBaseUpdate = $) : (b.next = $), (V.lastBaseUpdate = N)));
    }
    if (g !== null) {
      var K = h.baseState;
      (k = 0), (V = $ = N = null), (b = g);
      do {
        ...
        if ((f & q) === q) {
          ...
          b.callback !== null &&
            b.lane !== 0 &&
            ((r.flags |= 64), (q = h.effects), q === null ? (h.effects = [b]) : q.push(b));
        } else
          (Y = {
            eventTime: Y,
            lane: q,
        ...
        if (((b = b.next), b === null)) {
          ...
          (q = b), (b = q.next), (q.next = null), (h.lastBaseUpdate = q), (h.shared.pending = null);
        }
      } while (!0);
      if (
        (V === null && (N = K),
  ...
  var xc = [];
  function Sc() {
    for (var r = 0; r < xc.length; r++) xc[r]._workInProgressVersionPrimary = null;
    xc.length = 0;
  }
  ...
  function kc(r, i) {
    if (i === null) return !1;
    for (var a = 0; a < i.length && a < r.length; a++) if (!Xt(r[a], i[a])) return !1;
    return !0;
  }
  function Ec(r, i, a, f, h, g) {
    if (
      ...
      do {
        ...
        (g += 1), (Xe = We = null), (i.updateQueue = null), (zo.current = S0), (r = a(f, h));
      } while (yi);
    }
    if (
      ((zo.current = qo),
    ...
    if (h !== null) {
      ...
      do {
        ...
        if ((mr & V) === V)
          ...
          N === null ? ((b = N = K), (k = f)) : (N = N.next = K), (Pe.lanes |= V), (gr |= V);
        }
        $ = $.next;
      } while ($ !== null && $ !== g);
      N === null ? (k = f) : (N.next = b),
  ...
  function gh(r, i) {
    ...
    if (
      ...
      if (((a.flags |= 2048), xi(9, vh.bind(null, a, f, h, i), void 0, null), Ge === null))
        throw Error(n(349));
      mr & 30 || yh(a, i, h);
    }
    return h;
  ...
  function Uo(r, i, a, f) {
    var h = cn();
    (Pe.flags |= r), (h.memoizedState = xi(1 | i, a, void 0, f === void 0 ? null : f));
  }
  function Ho(r, i, a, f) {
    var h = Dt();
    f = f === void 0 ? null : f;
  ...
  function Ch(r, i, a) {
    return (a = a != null ? a.concat([r]) : null), Ho(4, 4, Nh.bind(null, i, r), a);
  }
  function Ac() {}
  function Ah(r, i) {
    var a = Dt();
    ...
    return f !== null && i !== null && kc(i, f[1]) ? f[0] : ((a.memoizedState = [r, i]), r);
  }
  function Lh(r, i) {
    var a = Dt();
    i = i === void 0 ? null : i;
  ...
  function Ih(r, i, a) {
    return mr & 21
      ? (Xt(a, i) || ((a = ld()), (Pe.lanes |= a), (gr |= a), (r.baseState = !0)), i)
  ...
  function y0(r, i, a) {
    var f = Qn(r);
    if (((a = { lane: f, action: a, hasEagerState: !1, eagerState: null, next: null }), Mh(r)))
      Oh(i, a);
  ...
  function v0(r, i, a) {
    ...
    if (Mh(r)) Oh(i, h);
      ...
      if (
        ...
        try {
          ...
          if (((h.hasEagerState = !0), (h.eagerState = b), Xt(b, k))) {
            var N = i.interleaved;
            N === null ? ((h.next = h), gc(i)) : ((h.next = N.next), (N.next = h)),
              (i.interleaved = h);
            return;
          }
        } catch {
      ...
      (a = uh(r, i, h, f)), a !== null && ((h = ft()), en(a, r, f, h), $h(a, i, f));
    }
  }
  function Mh(r) {
    var i = r.alternate;
  ...
  var qo = {
    ...
    w0 = {
      ...
      useImperativeHandle: function (r, i, a) {
        return (a = a != null ? a.concat([r]) : null), Uo(4194308, 4, Nh.bind(null, i, r), a);
      },
...
` +
  ...
  function zh(r, i, a) {
    ...
    return (
      g !== null &&
        ...
        (a.callback = function () {
          Mc(r, i), typeof f != 'function' && (Wn === null ? (Wn = new Set([this])) : Wn.add(this));
          var k = i.stack;
    ...
    return r.mode & 1
      ...
      : (r === i
          ...
          : ((r.flags |= 128),
            ...
            (a.flags &= -52805),
            a.tag === 1 &&
              (a.alternate === null ? (a.tag = 17) : ((i = xn(-1, 1)), (i.tag = 2), qn(a, i, 1))),
            (a.lanes |= 1)),
        r);
  }
  ...
  function Vh(r, i, a, f, h) {
    if (r === null) {
      ...
      return typeof g == 'function' &&
        ...
        : ((r = sl(a.type, null, f, i, i.mode, h)), (r.ref = i.ref), (r.return = i), (i.child = r));
    }
    if (((g = r.child), !(r.lanes & h))) {
      var k = g.memoizedProps;
      if (((a = a.compare), (a = a !== null ? a : oi), a(k, f) && r.ref === i.ref))
        return Sn(r, i, h);
    }
    return (i.flags |= 1), (r = Gn(g, f)), (r.ref = i.ref), (r.return = i), (i.child = r);
  }
  ...
  function Xh(r, i, a, f, h) {
    ...
    if ((ts(i, h), i.stateNode === null)) Ko(r, i), Rh(i, a, f), Ic(i, a, f, h), (f = !0);
    else if (r === null) {
      var k = i.stateNode,
        b = i.memoizedProps;
      k.props = b;
  ...
  function $c(r, i, a, f, h, g) {
    ...
    var b = k && typeof a.getDerivedStateFromError != 'function' ? null : f.render();
    return (
      (i.flags |= 1),
      r !== null && k
  ...
  function Yh(r, i, a) {
    var f = i.pendingProps,
      ...
      b;
    if (
      ((b = k) || (b = r !== null && r.memoizedState === null ? !1 : (h & 2) !== 0),
      b ? ((g = !0), (i.flags &= -129)) : (r === null || r.memoizedState !== null) && (h |= 1),
      Ne($e, h & 1),
      r === null)
    )
      return (
  ...
  function Dc(r, i) {
    return (
      (i = il({ mode: 'visible', children: i }, r.mode, 0, null)), (i.return = r), (r.child = i)
    );
  }
  function Wo(r, i, a, f) {
    return (
  ...
  function E0(r, i, a, f, h, g, k) {
    ...
    if (h.data === '$!') {
      ...
      return (f = b), (g = Error(n(419))), (f = jc(g, f, void 0)), Wo(r, i, k, f);
    }
    if (((b = (k & r.childLanes) !== 0), xt || b)) {
      if (((f = Ge), f !== null)) {
        ...
        (h = h & (f.suspendedLanes | k) ? 0 : h),
          h !== 0 && h !== g.retryLane && ((g.retryLane = h), wn(r, h), en(f, r, h, -1));
      }
  ...
  function ep(r, i, a) {
    var f = i.pendingProps,
      h = f.revealOrder,
      g = f.tail;
    if ((ut(r, i, f.children, a), (f = $e.current), f & 2)) (f = (f & 1) | 2), (i.flags |= 128);
    else {
      ...
      switch (h) {
        case 'forwards':
          for (a = i.child, h = null; a !== null; )
            (r = a.alternate), r !== null && Fo(r) === null && (h = a), (a = a.sibling);
          (a = h),
  ...
  function Sn(r, i, a) {
    if ((r !== null && (i.dependencies = r.dependencies), (gr |= i.lanes), !(a & i.childLanes)))
      return null;
    if (r !== null && i.child !== r.child) throw Error(n(153));
    if (i.child !== null) {
      for (r = i.child, a = Gn(r, r.pendingProps), i.child = a, a.return = i; r.sibling !== null; )
        (r = r.sibling), (a = a.sibling = Gn(r, r.pendingProps)), (a.return = i);
      a.sibling = null;
    }
    return i.child;
  }
        ...
        if (((f = i.memoizedState), f !== null))
          return f.dehydrated !== null
            ...
            : a & i.child.childLanes
              ? Yh(r, i, a)
              : (Ne($e, $e.current & 1), (r = Sn(r, i, a)), r !== null ? r.sibling : null);
        Ne($e, $e.current & 1);
        break;
      case 19:
      ...
      if (h !== f) {
        ...
        switch (a) {
          case 'input':
            ...
            break;
          case 'select':
            (h = Z({}, h, { value: void 0 })), (f = Z({}, f, { value: void 0 })), (g = []);
            break;
          case 'textarea':
            (h = Us(r, h)), (f = Us(r, f)), (g = []);
            break;
          default:
            typeof h.onClick != 'function' && typeof f.onClick == 'function' && (r.onclick = To);
        }
        xa(a, f);
        var k;
        a = null;
              ...
              if (b) {
                for (k in b)
                  !b.hasOwnProperty(k) ||
                    ...
                    (a || (a = {}), (a[k] = ''));
                for (k in N) N.hasOwnProperty(k) && b[k] !== N[k] && (a || (a = {}), (a[k] = N[k]));
              ...
              $ === 'dangerouslySetInnerHTML'
                ...
                : $ === 'children'
                  ...
                  : $ !== 'suppressContentEditableWarning' &&
                    $ !== 'suppressHydrationWarning' &&
                    (o.hasOwnProperty($)
                      ? (N != null && $ === 'onScroll' && Ae('scroll', r), g || b === N || (g = []))
                      : (g = g || []).push($, N));
        }
        a && (g = g || []).push('style', a);
        var $ = g;
    ...
    switch ((ac(i), i.tag)) {
      ...
      case 5:
        ...
        if (((a = i.type), r !== null && i.stateNode != null))
          np(r, i, a, f, h), r.ref !== i.ref && ((i.flags |= 512), (i.flags |= 2097152));
        else {
          if (!f) {
          ...
          if (((r = pr(an.current)), Mo(i))) {
            ...
            switch (((f[ln] = i), (f[fi] = g), (r = (i.mode & 1) !== 0), a)) {
              ...
              case 'input':
                ...
                break;
              case 'select':
                (f._wrapperState = { wasMultiple: !!g.multiple }), Ae('invalid', f);
                break;
              case 'textarea':
                ro(f, g), Ae('invalid', f);
            }
            ...
            for (var k in g)
              if (g.hasOwnProperty(k)) {
                ...
                k === 'children'
                  ? typeof b == 'string'
                    ? f.textContent !== b &&
                      (g.suppressHydrationWarning !== !0 && bo(f.textContent, b, r),
                      (h = ['children', b]))
                    : typeof b == 'number' &&
                      f.textContent !== '' + b &&
                      (g.suppressHydrationWarning !== !0 && bo(f.textContent, b, r),
                      (h = ['children', '' + b]))
                  : o.hasOwnProperty(k) && b != null && k === 'onScroll' && Ae('scroll', f);
              }
            switch (a) {
              case 'input':
                Ln(f), no(f, g, !0);
              ...
              switch (a) {
                ...
                case 'select':
                  (r.multiple = !!f.multiple),
                    ...
                    g != null
                      ? In(r, !!f.multiple, g, !1)
                      : f.defaultValue != null && In(r, !!f.multiple, f.defaultValue, !0);
                  break;
                default:
          ...
          if (Ie && jt !== null && i.mode & 1 && !(i.flags & 128))
            ...
            if (r === null) {
              ...
              if (((g = i.memoizedState), (g = g !== null ? g.dehydrated : null), !g))
                throw Error(n(317));
              g[ln] = i;
            } else Yr(), !(i.flags & 128) && (i.memoizedState = null), (i.flags |= 4);
            it(i), (g = !1);
        ...
        return i.flags & 128
          ...
          : ((f = f !== null),
            f !== (r !== null && r.memoizedState !== null) &&
              f &&
              ((i.child.flags |= 8192),
              i.mode & 1 && (r === null || $e.current & 1 ? Ke === 0 && (Ke = 3) : eu())),
            i.updateQueue !== null && (i.flags |= 4),
            it(i),
            null);
      case 4:
        return ns(), zc(r, i), r === null && ci(i.stateNode.containerInfo), it(i), null;
      case 10:
          ...
          if (!f)
            if (((r = Fo(k)), r !== null)) {
              if (
                ...
                Si(g, !0),
                g.tail === null && g.tailMode === 'hidden' && !k.alternate && !Ie)
              )
                return it(i), null;
            } else
      ...
      case 23:
        return (
          ...
          f && i.mode & 1
            ? Mt & 1073741824 && (it(i), i.subtreeFlags & 6 && (i.flags |= 8192))
            : it(i),
          null
        );
      case 24:
  ...
  function N0(r, i) {
    switch ((ac(i), i.tag)) {
      case 1:
        return (
          wt(i.type) && Co(), (r = i.flags), r & 65536 ? ((i.flags = (r & -65537) | 128), i) : null
        );
      case 3:
        return (
          ns(),
      ...
      case 5:
        return wc(i), null;
      case 13:
        if ((Le($e), (r = i.memoizedState), r !== null && r.dehydrated !== null)) {
  ...
  function A0(r, i) {
    ...
    for (ec = { focusedElem: r, selectionRange: a }, po = !1, ee = i; ee !== null; )
  ...
  function ip(r) {
    ...
    i !== null && ((r.alternate = null), ip(i)),
      ...
      r.tag === 5 &&
        ((i = r.stateNode),
        i !== null && (delete i[ln], delete i[fi], delete i[sc], delete i[f0], delete i[d0])),
      (r.stateNode = null),
      (r.return = null),
      (r.dependencies = null),
  ...
  function Hc(r, i, a) {
    ...
    if (f === 5 || f === 6)
      ...
      for (Hc(r, i, a), r = r.sibling; r !== null; ) Hc(r, i, a), (r = r.sibling);
  }
  function qc(r, i, a) {
    var f = r.tag;
  ...
  function ap(r, i, a) {
    ...
    switch (a.tag) {
      ...
      case 18:
        Ze !== null &&
          (Yt
            ? ((r = Ze),
              (a = a.stateNode),
              r.nodeType === 8 ? rc(r.parentNode, a) : r.nodeType === 1 && rc(r, a),
              ei(r))
            : rc(Ze, a.stateNode));
        break;
      case 4:
      ...
      case 14:
      case 15:
        if (!ot && ((f = a.updateQueue), f !== null && ((f = f.lastEffect), f !== null))) {
          h = f = f.next;
          do {
            var g = h,
              k = g.destroy;
            (g = g.tag), k !== void 0 && (g & 2 || g & 4) && Bc(a, i, k), (h = h.next);
          } while (h !== f);
        }
        Vn(r, i, a);
        break;
      case 1:
        if (!ot && (ss(a, i), (f = a.stateNode), typeof f.componentWillUnmount == 'function'))
          try {
  ...
  function Zt(r, i) {
    ...
    if (i.subtreeFlags & 12854) for (i = i.child; i !== null; ) up(i, r), (i = i.sibling);
  }
  function up(r, i) {
    var a = r.alternate,
      f = r.flags;
    switch (r.tag) {
      ...
      case 1:
        ...
        break;
      case 5:
        if ((Zt(i, r), un(r), f & 512 && a !== null && ss(a, a.return), r.flags & 32)) {
          var h = r.stateNode;
          try {
            le(h, '');
          } catch (ne) {
        ...
        if (f & 4 && ((h = r.stateNode), h != null)) {
          ...
          if (((r.updateQueue = null), N !== null))
            try {
              b === 'input' && g.type === 'radio' && g.name != null && to(h, g), Sa(b, k);
              var $ = Sa(b, g);
      ...
      case 6:
        ...
        break;
      case 3:
        if ((Zt(i, r), un(r), f & 4 && a !== null && a.memoizedState.isDehydrated))
          try {
            ei(i.containerInfo);
          } catch (ne) {
            Fe(r, r.return, ne);
      ...
      case 13:
        Zt(i, r),
          ...
          h.flags & 8192 &&
            ...
            !g || (h.alternate !== null && h.alternate.memoizedState !== null) || (Kc = Be())),
          f & 4 && cp(r);
        break;
      case 22:
        if (
          ...
          if ((($ = r.memoizedState !== null), (r.stateNode.isHidden = $) && !V && r.mode & 1))
  ...
  function fp(r, i, a) {
    for (var f = (r.mode & 1) !== 0; ee !== null; ) {
      ...
      if (h.tag === 22 && f) {
        ...
        dp(r);
      } else h.subtreeFlags & 8772 && g !== null ? ((g.return = h), (ee = g)) : dp(r);
    }
  }
  function dp(r) {
    for (; ee !== null; ) {
  ...
  function Qn(r) {
    return r.mode & 1
      ? we & 2 && et !== 0
        ...
        : p0.transition !== null
          ? (nl === 0 && (nl = ld()), nl)
          : ((r = ke), r !== 0 || ((r = window.event), (r = r === void 0 ? 16 : gd(r.type))), r)
      : 1;
  }
  function en(r, i, a, f) {
    ...
    Xs(r, a, f),
      (!(we & 2) || r !== Ge) &&
        ...
        _t(r, f),
        a === 1 && we === 0 && !(i.mode & 1) && ((os = Be() + 500), Lo && Un()));
  }
  function _t(r, i) {
    var a = r.callbackNode;
    pw(r, i);
    var f = uo(r, r === Ge ? et : 0);
    if (f === 0) a !== null && sd(a), (r.callbackNode = null), (r.callbackPriority = 0);
  ...
  function mp(r, i) {
    ...
    if (f & 30 || f & r.expiredLanes || i) i = rl(r, f);
      ...
      while (!0);
      hc(), (Go.current = g), (we = h), qe !== null ? (i = 0) : ((Ge = null), (et = 0), (i = Ke));
    }
    if (i !== 0) {
      if ((i === 2 && ((h = Aa(r)), h !== 0 && ((f = h), (i = Gc(r, h)))), i === 1))
      ...
      if (i === 6) Xn(r, f);
        ...
        switch (((r.finishedWork = h), (r.finishedLanes = f), i)) {
          ...
          case 2:
            ...
            break;
          case 3:
            if ((Xn(r, f), (f & 130023424) === f && ((i = Kc + 500 - Be()), 10 < i))) {
              if (uo(r, 0) !== 0) break;
  ...
  function Xn(r, i) {
    for (
      i &= ~Wc, i &= ~Jo, r.suspendedLanes |= i, r.pingedLanes &= ~i, r = r.expirationTimes;
      0 < i;
      ...
      try {
        ...
        e: {
          ...
          if (
            ...
            var Y = Uh(k);
            if (Y !== null) {
              (Y.flags &= -257), Hh(Y, k, b, g, i), Y.mode & 1 && Bh(g, $, i), (i = Y), (N = $);
            ...
            var Ue = Uh(k);
            if (Ue !== null) {
              !(Ue.flags & 65536) && (Ue.flags |= 256), Hh(Ue, k, b, g, i), fc(rs(N, b));
              break e;
            }
          }
          (g = N = rs(N, b)), Ke !== 4 && (Ke = 2), Ei === null ? (Ei = [g]) : Ei.push(g), (g = k);
          do {
            switch (g.tag) {
              case 3:
  ...
  function wp(r) {
    ...
    (r.memoizedProps = r.pendingProps), i === null ? xp(r) : (qe = i), (Vc.current = null);
  }
  function xp(r) {
    var i = r;
    do {
  ...
  function ls() {
    if (Kn !== null) {
      var r = ad(el),
        ...
        a = ke;
      try {
        if (((Ft.transition = null), (ke = 16 > r ? 16 : r), Kn === null)) var f = !1;
        else {
          ...
          if (((we = h), Un(), on && typeof on.onPostCommitFiberRoot == 'function'))
            try {
  ...
  function _p(r, i) {
    i === 0 && (r.mode & 1 ? ((i = co), (co <<= 1), !(co & 130023424) && (co = 4194304)) : (i = 1));
    var a = ft();
    ...
    switch (((i.lanes = 0), i.tag)) {
      ...
      case 3:
        e: {
          ...
          (f = i.pendingProps), (g = i.memoizedState), (h = g.element), fh(r, i), Do(i, f, null, a);
      ...
      case 14:
        return (f = i.type), (h = Jt(f, i.pendingProps)), (h = Jt(f.type, h)), Vh(r, i, f, h, a);
      case 15:
  ...
  function sl(r, i, a, f, h, g) {
    ...
    if (((f = r), typeof r == 'function')) tu(r) && (k = 1);
      ...
      e: switch (r) {
        ...
        case B:
          ...
          break;
        case j:
          return (r = zt(12, a, i, h | 2)), (r.elementType = j), (r.lanes = g), r;
        case J:
    ...
    return (i = zt(k, a, i, h)), (i.elementType = r), (i.type = f), (i.lanes = g), i;
  }
  function xr(r, i, a, f) {
    ...
    switch (r.tag) {
      case 3:
        ...
        if (i.current.memoizedState.isDehydrated) {
          ...
          a !== 0 && (Ia(i, a | 1), _t(i, Be()), !(we & 6) && ((os = Be() + 500), Un()));
        }
        break;
      case 13:
        yr(function () {
...
function m1(t) {
  ...
  for (const u of s)
    for (const d of u.actions) {
      ...
      d.parentId && (d.parentId = c.get(d.parentId) ?? d.parentId), e.set(p, { ...d, context: u });
    }
  return [...e.values()];
}
function g1(t, e) {
...
function _1(t) {
  ...
  const n = w1(t);
  return (
    (e = Dl(t).events.filter(s => s.time >= t.startTime && (!n || s.time < n.startTime))),
    (t[Bp] = e),
    e
  );
}
...
const E1 = 50,
  Fl = ({
    ...
    let T;
    s === 'vertical'
      ? ((T = v / window.devicePixelRatio), S && S.height < T && (T = S.height - 10))
      : ((T = p / window.devicePixelRatio), S && S.width < T && (T = S.width - 10)),
        ...
        children: [
          ...
          !e &&
            x.jsx('div', {
              ...
              onMouseDown: O => _({ offset: s === 'vertical' ? O.clientY : O.clientX, size: T }),
              onMouseUp: () => _(null),
              onMouseMove: O => {
                if (!O.buttons) _(null);
                else if (w) {
                  const D = (s === 'vertical' ? O.clientY : O.clientX) - w.offset,
                    ...
                    j = Math.min(Math.max(o, F), (s === 'vertical' ? B.height : B.width) - o);
                  s === 'vertical'
...
function j1(t) {
  ...
  const l = function (z) {
    ...
    O = function (z, J, de) {
      return z === 45 ? El(J) || J === 45 || T(J, de) : El(z) ? !0 : z === 92 ? T(z, J) : !1;
    },
    R = function () {
      return O(o, c(1), c(2));
    },
    ...
    B = function () {
      let z = '',
        J = 'integer';
      for ((c() === 43 || c() === 45) && (u(), (z += Qe(o))); Et(c()); ) u(), (z += Qe(o));
      if (c(1) === 46 && Et(c(2)))
        for (u(), z += Qe(o), u(), z += Qe(o), J = 'number'; Et(c()); ) u(), (z += Qe(o));
      const de = c(1),
        Ee = c(2),
        Ce = c(3);
      if ((de === 69 || de === 101) && Et(Ee))
        ...
        for (u(), z += Qe(o), u(), z += Qe(o), u(), z += Qe(o), J = 'number'; Et(c()); )
          u(), (z += Qe(o));
      const ye = j(z);
...
class lt extends He {
  constructor(e) {
    super(), (this.tokenType = 'DELIM'), (this.value = ''), (this.value = Qe(e));
  }
  toString() {
...
function F1(t) {
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    s >= 128 || s === 45 || s === 95 || Ve(s, 48, 57) || Ve(s, 65, 90) || Ve(s, 97, 122)
      ? (e += t[n])
      : (e += '\\' + s.toString(16) + ' ');
  }
  return e;
...
function z1(t, e) {
  ...
  try {
    ...
    const Q = j.message + ` while parsing css selector "${t}". Did you mean to CSS.escape it?`,
      W = (j.stack || '').indexOf(j.message);
    throw (
      (W !== -1 &&
        (j.stack = j.stack.substring(0, W) + Q + j.stack.substring(W + j.message.length)),
      (j.message = Q),
      j)
    );
  }
  ...
  function D() {
    ...
    for (
      ...
      if ((u(), T())) (j.simples[j.simples.length - 1].combinator = n[o++].value), u();
      else if (C()) break;
    ...
    for (; !C(); )
      if (d() || S()) j += n[o++].toSource();
        ...
        if ((o++, d()))
          ...
          const W = n[o++].value.toLowerCase();
          if (
            (e.has(W) ? (Q.push({ name: W, args: O() }), l.add(W)) : (j += `:${W}(${U()})`),
            u(),
            !w())
          )
            throw c();
        ...
        for (j += '[', o++; !(n[o] instanceof Bu) && !E(); ) j += n[o++].toSource();
  ...
  function U() {
    let j = '',
      Q = 1;
    for (; !E() && ((m() || _()) && Q++, w() && Q--, !!Q); ) j += n[o++].toSource();
    return j;
  }
  const B = O();
  if (!E()) throw c();
  if (B.some(j => typeof j != 'object' || !('simples' in j)))
    throw new bt(`Error while parsing css selector "${t}". Did you mean to CSS.escape it?`);
...
function Yl(t) {
  ...
  for (const s of e.parts) {
    ...
    if (Uu.has(s.name)) {
      ...
      const c = { name: s.name, source: s.body, body: { parsed: Yl(o), distance: l } },
  ...
  if (Uu.has(n[0].name)) throw new bt(`"${n[0].name}" selector cannot be first`);
...
function q1(t) {
  ...
  const o = { parts: [] },
    l = () => {
      ...
      let v = !1;
      if (
        (p[0] === '*' && ((v = !0), (p = p.substring(1))), o.parts.push({ name: p, body: y }), v)
      ) {
        if (o.capture !== void 0)
          throw new bt('Only one of the selectors can capture using * modifier');
...
function Cr(t, e) {
  ...
  function y(E) {
    let T = l();
    for (T !== E && c('parsing quoted string'); !s && o() !== E; ) o() === '\\' && l(), (T += l());
  ...
  function _() {
    ...
    return { name: E.join('.'), jsonPath: E, op: T, value: C, caseSensitive: O };
  }
  const S = { name: '', attributes: [] };
  for (S.name = p(), u(); o() === '['; ) S.attributes.push(_()), u();
  if ((s || c(void 0), !S.name && !S.attributes.length))
    throw new bt(`Error while parsing selector \`${t}\` - selector cannot be empty`);
  return S;
}
function Zl(t, e = "'") {
  ...
  for (let u = 0; u < o.length; u++) {
    ...
    if (d.name === 'internal:control' && d.body === 'enter-frame') {
      const _ = l[l.length - 1],
        S = o[u - 1],
        E = _.map(T => t.chainLocators([T, t.generateLocator(p, 'frame', '')]));
    ...
    switch (n) {
      ...
      case 'role':
        ...
        for (const { name: u, value: d } of o.attrs) {
          ...
          typeof d == 'boolean' && (p = d ? 'True' : 'False'), l.push(`${vg(u)}=${p}`);
        }
        const c = l.length ? `, ${l.join(', ')}` : '';
...
class Z1 {
  ...
  toHasText(e) {
    return tt(e) ? `HasTextRegex = ${this.regexToString(e)}` : `HasText = ${this.quote(e)}`;
  }
  toTestIdValue(e) {
    return tt(e) ? this.regexToString(e) : this.quote(e);
  }
  toHasNotText(e) {
    return tt(e) ? `HasNotTextRegex = ${this.regexToString(e)}` : `HasNotText = ${this.quote(e)}`;
  }
  quote(e) {
    return Zl(e, '"');
  }
...
function nx({
  ...
  const E = P.useMemo(() => rx(e, u, v.expandedItems, S || 0, c), [e, u, v, S, c]),
    T = P.useRef(null),
    [C, O] = P.useState(),
    [R, D] = P.useState(!1);
  P.useEffect(() => {
    ...
    children: x.jsxs('div', {
      ...
      onKeyDown: U => {
        ...
        if ((U.stopPropagation(), U.preventDefault(), u && U.key === 'ArrowLeft')) {
          ...
          j ? (v.expandedItems.set(u.id, !1), m({ ...v })) : Q && (p == null || p(Q));
          return;
        }
        ...
        let B = u;
        if (
          (U.key === 'ArrowDown' && (u ? (B = E.get(u).next) : E.size && (B = [...E.keys()][0])),
          U.key === 'ArrowUp')
        ) {
          if (u) B = E.get(u).prev;
          else if (E.size) {
      ...
      ref: T,
      children: [
        w && E.size === 0 && x.jsx('div', { className: 'tree-view-empty', children: w }),
        e.children.map(
          U =>
            E.get(U) &&
            x.jsx(
      ...
      x.jsxs('div', {
        ...
        children: [
          T
            ? new Array(T)
                .fill(0)
                .map((B, j) => x.jsx('div', { className: 'tree-view-indent' }, 'indent-' + j))
            : void 0,
          x.jsx('div', {
            'aria-hidden': 'true',
            className: 'codicon ' + O,
  ...
  const d = (p, y) => {
    for (const v of p.children) {
      ...
      const m = c.has(v.id) || n.get(v.id),
        ...
        S = { depth: y, expanded: _, parent: t === p ? null : p, next: null, prev: u };
...
const ix = nx,
  ox = ({
    ...
    const [y, v] = P.useState({ expandedItems: new Map() }),
      ...
      E = P.useCallback(D => s({ minimum: D.action.startTime, maximum: D.action.endTime }), [s]),
      T = P.useCallback(
        D =>
          af(D.action, {
            sdkLanguage: o,
  ...
  af = (t, e) => {
    ...
    const {
      ...
      m =
        t.class === 'Test' &&
        t.method === 'step' &&
        ((S = t.annotations) == null ? void 0 : S.some(E => E.type === 'skip'));
    let w = '';
    return (
      t.endTime ? (w = mt(t.endTime - t.startTime)) : t.error ? (w = 'Timed out') : l || (w = '-'),
      x.jsxs(x.Fragment, {
        children: [
          x.jsxs('div', {
                ...
                !!p &&
                  x.jsxs('div', {
                    ...
                    children: [
                      ...
                      x.jsx('span', { className: 'action-icon-value', children: p }),
                    ],
                  }),
              ],
            }),
...
const ax = t => {
  ...
  kg = (t, e, n = !1) => {
    ...
    if (!n && s.selector !== void 0)
      return { type: 'locator', value: nr(e, s.selector), childDisplayString: kg(t, e, !0) };
...
function hx(t) {
  return t.endTime ? mt(t.endTime - t.startTime) : t.error ? 'Timed Out' : 'Running';
}
function Qp(t) {
    ...
    x.jsxs(
      'div',
      {
        ...
        children: [
          t.name,
          ':',
          x.jsx('span', { className: ze('call-value', t.type), title: t.text, children: e }),
...
function Xp(t, e, n, s) {
  ...
  if (
    ...
    return { text: nr(s || 'javascript', t.params.selector), type: 'locator', name: 'locator' };
  const l = typeof n;
    ...
    x.jsx('div', {
      ...
      children: x.jsxs('div', {
        ...
        onKeyDown: O => {
          ...
          Km(F || void 0), v == null || v(void 0), y == null || y(e[D], D), C(void 0);
        },
        ref: E,
        children: [
...
function qi(t, e) {
  ...
  for (; (o = n.exec(t)) !== null; ) {
    ...
    if (p) {
      ...
      m !== void 0 && (v.color = m);
      const w = c ? u : d;
      w !== void 0 && (v['background-color'] = w), s.push(`<span style="${yx(v)}">${gx(y)}</span>`);
    }
  }
  return s.join('');
}
...
function mS(t) {
  return Jx.test(t) ? 'right' : Xx.test(t) ? 'center' : Gx.test(t) ? 'left' : null;
}
function rm(t, e, n, s) {
  const o = n.inTable;
  n.inTable = !0;
  ...
  return (
    t
      ...
      .filter(Boolean)
      .forEach((d, p, y) => {
        d.trim() === '|' && (u(), s) ? p !== 0 && p !== y.length - 1 && l.push([]) : (c += d);
      }),
    u(),
    (n.inTable = o),
    l
...
function _S(t = '', e = {}) {
  function n(m, w, ..._) {
    ...
    return e.createElement(
      ...
      kr({}, w, S, { className: SS(w == null ? void 0 : w.className, S.className) || void 0 }),
      ..._
    );
  }
  function s(m) {
...
`,
    ...
    for (; typeof _[_.length - 1] == 'string' && !_[_.length - 1].trim(); ) _.pop();
    ...
    if (_.length > 1 || e.forceWrapper) E = _;
      ...
      if (_.length === 1)
        return (E = _[0]), typeof E == 'string' ? n('span', { key: 'outer' }, E) : E;
      E = null;
    }
    ...
    return _
      ? _.reduce(function (S, E) {
          ...
          if (T !== -1) {
            ...
            typeof D == 'string' && (Hu.test(D) || qu.test(D)) && (S[R] = s(D.trim()));
  ...
  (e.overrides = e.overrides || {}),
    ...
    (e.namedCodesToUnicode = e.namedCodesToUnicode ? kr({}, tm, e.namedCodesToUnicode) : tm),
    ...
    u = {
      [ae.blockQuote]: {
        ...
        render(m, w, _) {
          ...
          return (
            m.alert &&
              ((S.className = 'markdown-alert-' + e.slugify(m.alert.toLowerCase(), Li)),
              m.children.unshift({
                attrs: {},
      ...
      [ae.codeBlock]: {
        match: En(Ng),
        order: 0,
        parse: m => ({ lang: void 0, text: Vi(m[0].replace(/^ {4}/gm, '')).replace(pu, '$1') }),
        render: (m, w, _) =>
          n(
            'pre',
            { key: _.key },
            n('code', kr({}, m.attrs, { className: m.lang ? `lang-${m.lang}` : '' }), m.text)
          ),
      },
      [ae.codeFenced]: {
        match: En(Tg),
      ...
      [ae.gfmTask]: {
        ...
        render: (m, w, _) =>
          n('input', { checked: m.completed, key: _.key, readOnly: !0, type: 'checkbox' }),
      },
      [ae.heading]: {
        ...
        render: (m, w, _) => n(`h${m.level}`, { id: m.id, key: _.key }, w(m.children, _)),
      },
      [ae.headingSetext]: {
        match: En(Lg),
        order: 0,
      ...
      [ae.htmlBlock]: {
        ...
        render: (m, w, _) =>
          n(m.tag, kr({ key: _.key }, m.attrs), m.text || (m.children ? w(m.children, _) : '')),
      },
      [ae.htmlSelfClosing]: {
        match: Ii(qu),
        order: 1,
      ...
      [ae.htmlComment]: { match: Ii(Ig), order: 1, parse: () => ({}), render: yu },
      [ae.image]: {
        match: Zn(hS),
        order: 1,
      ...
      [ae.link]: {
        match: Yn(dS),
        order: 3,
        parse: (m, w, _) => ({ children: wS(w, m[1], _), target: im(m[2]), title: m[3] }),
        render: (m, w, _) =>
          n(
            'a',
            { key: _.key, href: e.sanitizer(m.target, 'a', 'href'), title: m.title },
            w(m.children, _)
          ),
      },
      ...
      [ae.linkBareUrlDetector]: {
        match: Ts((m, w) => (w.inAnchor || e.disableAutoLink ? null : Yn(Fx)(m, w))),
        order: 0,
        parse: m => ({
...
`,
      ...
      [ae.refLink]: {
        match: Yn(Vx),
        order: 0,
        parse: (m, w, _) => ({ children: w(m[1], _), fallbackChildren: m[0], ref: m[2] }),
        render: (m, w, _) =>
          c[m.ref]
            ? n(
                'a',
      ...
      [ae.textEscaped]: { match: Zn(nS), order: 1, parse: m => ({ text: m[1], type: ae.text }) },
      [ae.textMarked]: {
        match: Zn(eS),
        order: 3,
        parse: mu,
  ...
  let { children: e = '', options: n } = t,
    s = (function (o, l) {
      ...
      var c,
        ...
        d = {},
        p = Object.keys(o);
      for (u = 0; u < p.length; u++) l.indexOf((c = p[u])) >= 0 || (d[c] = o[c]);
      return d;
    })(t, wx);
...
function mT({ children: t }) {
  const e = r1(),
    n = P.useMemo(() => {
      ...
      if (s.openai_api_key) return new lm(new ES(s.openai_api_key, s.openai_base_url));
      if (s.anthropic_api_key) return new lm(new bS(s.anthropic_api_key, s.anthropic_base_url));
    }, [e]);
...
const qg = ({ cursor: t, onPaneMouseMove: e, onPaneMouseUp: n, onPaneDoubleClick: s }) => (
    At.useEffect(() => {
        ...
        e.map((m, w) =>
          x.jsx(
            'div',
            {
              ...
              onMouseDown: _ => d({ clientX: _.clientX, clientY: _.clientY, offset: m, index: w }),
  ...
  jS = ({
    ...
    return x.jsxs('div', {
      ...
      children: [
        ...
        x.jsxs('div', {
          style: { position: 'relative', width: n, height: s, margin: 15, ...Vu },
          children: [
            x.jsx(Vg, {
  ...
  bn = ({
    ...
    x.jsxs('div', {
      ...
      children: [
        ...
        x.jsx('div', {
          style: { display: 'flex', flex: 'none', width: o, height: l, margin: 15, ...Vu },
          children: x.jsx('img', {
          ...
          if (
            ...
            return new Promise((_, S) => {
              w.addEventListener('load', _),
                w.addEventListener('error', () => S(new Error(`Unable to preload CSS for ${p}`)));
            });
        })
      );
    }
  ...
  Ns = ({
    ...
    return (
      P.useEffect(() => {
        (async () => {
          ...
          if (
            ...
            return;
          (j = (B = T.current) == null ? void 0 : B.cm) == null || j.getWrapperElement().remove();
          const U = R(D, {
            value: '',
            mode: F,
            readOnly: !!o,
      ...
      P.useLayoutEffect(() => {
        ...
        if (
          (C.getValue() !== t &&
            (C.setValue(t), (R = !0), p && (C.execCommand('selectAll'), C.focus())),
          R || JSON.stringify(l) !== JSON.stringify(T.current.highlight))
        ) {
          for (const j of T.current.highlight || []) C.removeLineClass(j.line - 1, 'wrap');
          for (const j of l || []) C.addLineClass(j.line - 1, 'wrap', `source-line-${j.type}`);
          ...
          for (const j of l || []) {
            ...
            const Q = (F = T.current) == null ? void 0 : F.cm.getLine(j.line - 1);
            if (Q) {
              const W = {};
              (W.title = j.message || ''),
                B.push(
            ...
            if (j.type === 'error') {
              ...
              (W.innerHTML = qi(j.message || '')),
                ...
                U.push(C.addLineWidget(j.line, W, { above: !0, coverGutter: !1 }));
            }
          }
      ...
      x.jsx('div', { 'data-testid': m, className: 'cm-wrapper', ref: S, onClick: RS })
    );
  };
function RS(t) {
  var n;
...
function DS(t) {
  cm ||
    ((cm = !0),
    t.defineSimpleMode('text/linkified', { start: [{ regex: Qm, token: 'linkified' }] }));
}
function FS(t) {
  if (t) {
...
const US = ({ title: t, children: e, setExpanded: n, expanded: s, expandOnTitleClick: o }) => {
  const l = P.useId();
  return x.jsxs('div', {
...
const qS = ({ attachment: t, reveal: e }) => {
    ...
    P.useEffect(() => {
      var S;
      if (e) return (S = y.current) == null || S.scrollIntoView({ behavior: 'smooth' }), p();
    }, [e, p]),
      P.useEffect(() => {
        n &&
          o === null &&
...
`).length
      ...
      _ = x.jsxs('span', {
        ...
        children: [
          ...
          m && x.jsx('a', { style: { marginLeft: 5 }, href: Il(t), children: 'download' }),
        ],
      });
    return !v || !m
          ...
          children: [
                ...
                children: [
                  ...
                  l &&
                    ...
                    x.jsx(IS, {
                      ...
                      diff: {
                        name: 'Image diff',
                        expected: { attachment: { ...l, path: Il(l) }, title: 'Expected' },
                        actual: { attachment: { ...c, path: Il(c) } },
                        diff: u ? { attachment: { ...u, path: Il(u) } } : void 0,
                      },
                    }),
                ],
              })
            ...
            [...o.values()].map((l, c) =>
              x.jsx(
                ...
                {
                  className: 'attachment-item',
                  children: x.jsx(qS, { attachment: l, reveal: e && WS(l, e[0]) ? e : void 0 }),
                },
                KS(l, c)
              )
            ),
...
function GS({ message: t, error: e, errorId: n, sdkLanguage: s, revealInSource: o }) {
  var m;
  const [l, c] = P.useState(!1),
    u = NS();
  let d, p;
  const y = (m = e.stack) == null ? void 0 : m[0];
  y && ((d = y.file.replace(/.*[/\\](.*)/, '$1') + ':' + y.line), (p = y.file + ':' + y.line));
  const v = Vm(
        ...
        children: [
          ...
          d &&
            x.jsxs('div', {
              ...
              children: ['@ ', x.jsx('span', { title: p, onClick: () => o(e), children: d })],
            }),
          x.jsx('span', {
            ...
            children:
              v &&
              (u
                ? x.jsx(JS, { conversationId: n, onChange: c, value: l, prompt: v })
                : x.jsx(QS, { prompt: v })),
          }),
        ],
      }),
...
const YS = ({ errorsModel: t, sdkLanguage: e, revealInSource: n, wallTime: s }) =>
    t.errors.size
      ? x.jsx('div', {
          className: 'fill',
          style: { overflow: 'auto' },
...
const t_ = ({ consoleModel: t, boundaries: e, onEntryHovered: n, onAccepted: s }) =>
  t.entries.length
    ? x.jsx('div', {
            ...
            return (
              ...
              x.jsxs('div', {
                ...
                children: [
                  c,
                  d,
                  p && x.jsx('span', { className: 'console-location', children: p }),
                  o.repeat > 1 &&
...
function n_(t) {
  ...
  for (; (c = l.exec(n)) !== null; ) {
    ...
    if (v === '%') d.push(x.jsx('span', { children: '%' }));
      ...
      typeof (m == null ? void 0 : m.value) != 'string' &&
        ...
        d.push(x.jsx('span', { style: w, children: (m == null ? void 0 : m.preview) || '' }));
    } else if (v === 'c') {
      d = [];
      const m = s[o++],
        w = m ? r_(m.preview) : {};
  ...
  for (p < n.length && d.push(x.jsx('span', { children: n.substring(p) })); o < s.length; o++) {
    const y = s[o],
      v = {};
    d.length && d.push(x.jsx('span', { children: ' ' })),
      typeof (y == null ? void 0 : y.value) != 'string' &&
        (v.color = 'var(--vscode-debugTokenExpression-number)'),
      d.push(x.jsx('span', { style: v, children: (y == null ? void 0 : y.preview) || '' }));
  }
  return u;
}
function Kg(t) {
...
const df = ({
  ...
  Qg = ({ id: t, title: e, count: n, errorCount: s, selected: o, onSelect: l, ariaControls: c }) =>
    x.jsxs('div', {
...
async function o_(t, e = 0) {
  const n = new Set([
    ...
    c = l.reduce((_, S) => {
      const E = S.name;
      return !n.has(E.toLowerCase()) && !E.includes(':') && _.append(E, S.value), _;
    }, new Headers()),
    u = {};
  for (const _ of c) u[_[0]] = _[1];
  const d =
      t.request.cookies.length || l.some(({ name: _ }) => s.has(_.toLowerCase()))
        ? 'include'
        : 'omit',
...
const d_ = ({ resource: t, sdkLanguage: e, startTimeOffset: n, onClose: s }) => {
    const [o, l] = P.useState('request');
    return x.jsx(Wu, {
      dataTestId: 'network-request-details',
      leftToolbar: [x.jsx(Vt, { icon: 'close', title: 'Close', onClick: s }, 'close')],
      tabs: [
        {
          id: 'request',
          title: 'Request',
          render: () => x.jsx(h_, { resource: t, sdkLanguage: e, startTimeOffset: n }),
        },
        { id: 'response', title: 'Response', render: () => x.jsx(p_, { resource: t }) },
      ...
      P.useEffect(() => {
        (async () => {
          if (t.request.postData) {
            const c = t.request.headers.find(d => d.name.toLowerCase() === 'content-type'),
              u = c ? c.value : '';
            ...
            ? x.jsxs(x.Fragment, {
                children: [
                  ...
                  x.jsx('div', {
                    ...
                    children: t.request.queryString.map(l => `${l.name}: ${l.value}`).join(`
`),
                  }),
                ],
              })
          ...
          x.jsx('div', {
            className: 'network-request-details-headers',
            children: t.request.headers.map(l => `${l.name}: ${l.value}`).join(`
`),
          }),
          ...
          x.jsxs('div', {
            ...
            children: [
              ...
              x.jsx(Al, {
                ...
                value: async () =>
                  f_(e).generatePlaywrightRequestCall(t.request, s == null ? void 0 : s.text),
              }),
            ],
          }),
          s &&
            x.jsx('div', { className: 'network-request-details-header', children: 'Request Body' }),
          s && x.jsx(Ns, { text: s.text, mimeType: s.mimeType, readOnly: !0, lineNumbers: !0 }),
        ],
      })
    );
  },
    ...
    return (
      ...
      x.jsxs('div', {
        ...
        children: [
          ...
          e &&
            e.text &&
            x.jsx(Ns, { text: e.text, mimeType: e.mimeType, readOnly: !0, lineNumbers: !0 }),
        ],
      })
    );
  },
...
const b_ = ({ boundaries: t, networkModel: e, onEntryHovered: n, sdkLanguage: s }) => {
    const [o, l] = P.useState(void 0),
      [c, u] = P.useState(void 0),
      [d, p] = P.useState(S_),
      { renderedEntries: y } = P.useMemo(() => {
        const S = e.resources.map(E => I_(E, t, e.contextIdMap)).filter(P_(d));
    ...
    y = (w, _) => {
      for (const S of _.items) {
        if (
          ...
          c.push({ message: 'Only string keys are supported', range: u(S.key.range || _.range) });
          continue;
        }
        const T = S.key,
          C = S.value;
        ...
        if (C instanceof t.Scalar) {
          ...
          w.children.push({ ...O, children: [{ kind: 'text', text: fm(String(C.value)) }] });
          continue;
        }
...
function fm(t) {
  return t.startsWith('/') && t.endsWith('/') && t.length > 1 ? { pattern: t.slice(1, -1) } : Jg(t);
}
class Hl {
  static parse(e, n, s) {
    try {
...
function ry(t, e) {
  return [...F_].some(([n, s]) => !(s != null && s.has(e || '')) && t.hasAttribute(n));
}
function sy(t) {
...
const xu = {
    ...
    HTML: () => 'document',
    IMG: t =>
      t.getAttribute('alt') === '' && !t.getAttribute('title') && !ry(t) && !sy(t)
        ? 'presentation'
        : 'img',
    INPUT: t => {
...
function Ut(t) {
  ...
  if ((e == null ? void 0 : e.display) === 'contents' && !n) {
    for (let o = t.firstChild; o; o = o.nextSibling)
      if ((o.nodeType === 1 && !Ut(o)) || (o.nodeType === 3 && ny(o))) return !1;
    return !0;
  }
  return !(t.nodeName === 'OPTION' && !!t.closest('select')) && !n && !ty(t, e) ? !0 : ay(t);
}
function ay(t) {
  ...
  if (e === void 0) {
    if (
      ...
      const n = jr(t);
      e = !n || n.display === 'none' || oy(t.getAttribute('aria-hidden')) === !0;
    }
    if (!e) {
      const n = pt(t);
      n && (e = ay(n));
  ...
  return (
    s === void 0 &&
      ...
      [
        ...
        (s = Bi(
          nn(t, { includeHidden: e, visitedElements: new Set(), embeddedInTargetElement: 'self' })
        )),
      n == null || n.set(t, s)),
    s
  );
  ...
  if (e.embeddedInLabel || e.embeddedInLabelledBy || e.embeddedInTargetElement === 'descendant') {
    ...
    if (!m && !w) {
      ...
      if (['combobox', 'listbox'].includes(o)) {
        ...
        let _;
        if (l === 'SELECT')
          (_ = [...t.selectedOptions]), !_.length && t.options.length && _.push(t.options[0]);
        else {
          const S = o === 'combobox' ? gm(t, '*').find(E => Ye(E) === 'listbox') : t;
          _ = S ? gm(S, '[aria-selected="true"]').filter(E => Ye(E) === 'option') : [];
        }
        return !_.length && l === 'INPUT' ? t.value : _.map(S => nn(S, n)).join(' ');
      }
  ...
  if (!['presentation', 'none'].includes(o)) {
    ...
    if (!s && l === 'FIELDSET') {
      ...
      for (let w = t.firstElementChild; w; w = w.nextElementSibling)
        if (nt(w) === 'LEGEND')
          return nn(w, { ...n, embeddedInNativeTextAlternative: { element: w, hidden: Ut(w) } });
    ...
    if (l === 'SVG' || t.ownerSVGElement) {
      ...
      for (let m = t.firstElementChild; m; m = m.nextElementSibling)
        if (nt(m) === 'TITLE' && m.ownerSVGElement)
          return nn(m, { ...n, embeddedInLabelledBy: { element: m, hidden: Ut(m) } });
    }
...
const pf = ['gridcell', 'option', 'row', 'tab', 'rowheader', 'columnheader', 'treeitem'];
function uy(t) {
  return nt(t) === 'OPTION'
    ? t.selected
    : pf.includes(Ye(t) || '')
...
function yy(t) {
  return t ? (nt(t) === 'FIELDSET' && t.hasAttribute('disabled') ? !0 : yy(t.parentElement)) : !1;
}
function vy(t) {
  if (!t) return !1;
  if (my.includes(Ye(t) || '')) {
...
function Kl(t) {
  ...
  function l(c, u, d = []) {
    var m;
    const y =
      (((m = jr(u)) == null ? void 0 : m.display) || 'inline') !== 'inline' || u.nodeName === 'BR'
        ? ' '
        : '';
    ...
    if (v.length) for (const w of v) o(c, w);
      ...
      for (let w = u.firstChild; w; w = w.nextSibling) w.assignedSlot || o(c, w);
      if (u.shadowRoot) for (let w = u.shadowRoot.firstChild; w; w = w.nextSibling) o(c, w);
    }
  ...
  const n = [],
    ...
    l = (c, u, d) => {
      ...
      if (c.name && c.name.length <= 900) {
        const v = o(c.name);
        if (v) {
          const m = v.startsWith('/') && v.endsWith('/') ? v : JSON.stringify(v);
          p += ' ' + m;
        }
      }
      if (
...
class Su {
  ...
  runHighlightOnRaf(e) {
    this._rafRequest && cancelAnimationFrame(this._rafRequest),
      this.updateHighlight(
        this._injectedScript.querySelectorAll(e, this._injectedScript.document.documentElement),
  ...
  _innerUpdateHighlight(e, n) {
    let s = n.color;
    if ((s || (s = e.length > 1 ? '#f6b26b7f' : '#6fa8dc7f'), !this._highlightIsUpToDate(e, n))) {
      this.clearHighlight(),
      ...
      for (let o = 0; o < e.length; ++o) {
        ...
        if (n.tooltipList || n.tooltipText || n.tooltipFooter) {
          ...
          for (let d = 0; d < u.length; d++) {
            const p = this._injectedScript.document.createElement('x-pw-tooltip-line');
            (p.textContent = u[d]),
              c.appendChild(p),
              n.tooltipListItemSelected &&
                ...
                p.addEventListener('click', () => {
                  var y;
                  return (y = n.tooltipListItemSelected) == null ? void 0 : y.call(n, d);
                }));
          }
          if (n.tooltipFooter) {
            const d = this._injectedScript.document.createElement('x-pw-tooltip-footer');
      ...
      for (const o of this._highlightEntries) {
        if (((o.box = o.targetElement.getBoundingClientRect()), !o.tooltipElement)) continue;
        const { anchorLeft: l, anchorTop: c } = this.tooltipPosition(o.box, o.tooltipElement);
          ...
          this._isUnderTest &&
            console.error(
              'Highlight box for test: ' +
                JSON.stringify({ x: l.x, y: l.y, width: l.width, height: l.height })
            );
      }
    }
  }
  ...
  _highlightIsUpToDate(e, n) {
    ...
    if (n.tooltipList && this._highlightOptions.tooltipList) {
      for (let l = 0; l < n.tooltipList.length; l++)
        if (n.tooltipList[l] !== this._highlightOptions.tooltipList[l]) return !1;
    }
    ...
    for (let l = 0; l < this._highlightEntries.length; ++l) {
      ...
      if (u.top !== c.top || u.right !== c.right || u.bottom !== c.bottom || u.left !== c.left)
        return !1;
    }
    return !0;
  }
...
function ia(t, e, n) {
  ...
  for (let s = e.firstChild; s; s = s.nextSibling)
    if (s.nodeType === Node.ELEMENT_NODE && n(Ct(t, s))) return 'selfAndChildren';
...
function Ny(t, e) {
  ...
  if (s !== null && s.trim()) return [{ full: s, normalized: gt(s), immediate: [s] }];
...
function Cy(t) {
  var s;
  const e = { key: wk(t), name: vk(t), children: xk(t).map(Cy), rootElements: [], props: Sk(t) },
      ...
      if (
        ...
        if (e.name !== void 0) {
          ...
          if (
            ...
            !Ty(u, { op: e.nameOp || '=', value: e.name, caseSensitive: !!e.exact }))
          )
            return;
        }
        s.push(c);
...
const Di = {
  ...
  jk = {
    matches(t, e, n, s) {
      ...
      const o = gt(e[0]),
        l = c => (!o && !c.immediate.length ? !0 : c.immediate.some(u => gt(u) === o));
  ...
  Ok = {
    matches(t, e, n, s) {
      ...
      if (Cf(t)) return !1;
      const o = gt(e[0]).toLowerCase();
      return (c => c.normalized.toLowerCase().includes(o))(Ct(s._cacheText, t));
    },
  };
function Mi(t) {
  return {
...
function us(t, e, n) {
  if (n.root && !sa(n.root, e)) throw new Error("Target element must belong to the root's subtree");
  if (e === n.root) return [{ engine: 'css', selector: ':scope', score: 1 }];
  if (e.ownerDocument.documentElement === e) return [{ engine: 'css', selector: 'html', score: 1 }];
  const s = (l, c) => {
      const u = l === e;
      let d = c ? Gk(t, l, l === e) : [];
      l !== e && (d = bm(d));
      const p = Xk(t, l, n)
        .filter(m => !n.omitInternalEngines || !m.engine.startsWith('internal:'))
        .map(m => [m]);
...
function Xk(t, e, n) {
  const s = [];
  {
    for (const c of ['data-testid', 'data-test-id', 'data-test'])
      c !== n.testIdAttributeName &&
        e.getAttribute(c) &&
        s.push({ engine: 'css', selector: `[${c}=${Ci(e.getAttribute(c))}]`, score: Pk });
    if (!n.noCSSId) {
      const c = e.getAttribute('id');
      c && !Jk(c) && s.push({ engine: 'css', selector: Uy(c), score: Wk });
    }
    s.push({ engine: 'css', selector: Ht(e.nodeName.toLowerCase()), score: zy });
  }
  ...
  for (const c of o) {
    ...
    for (const d of ys(u))
      s.push({ engine: 'internal:label', selector: Tt(d.text, !1), score: Py - d.scoreBonus });
  }
  const l = Ye(e);
  return (
    l &&
    ...
    ['INPUT', 'TEXTAREA', 'SELECT'].includes(e.nodeName) &&
      e.getAttribute('type') !== 'hidden' &&
      s.push({ engine: 'css', selector: Ht(e.nodeName.toLowerCase()), score: ku + 1 }),
    Gu([s]),
    s
  );
}
function Gk(t, e, n) {
  ...
  if (o) {
    s.push([{ engine: 'internal:attr', selector: `[title=${ht(o, !0)}]`, score: qk }]);
    for (const p of ys(o))
      s.push([
        {
          engine: 'internal:attr',
  ...
  if (l && ['APPLET', 'AREA', 'IMG', 'INPUT'].includes(e.nodeName)) {
    s.push([{ engine: 'internal:attr', selector: `[alt=${ht(l, !0)}]`, score: Uk }]);
    for (const p of ys(l))
      s.push([
  ...
  if (c) {
    if (n) {
      c.length <= 80 && s.push([{ engine: 'internal:text', selector: Tt(c, !0), score: Hk }]);
      for (const y of u)
        s.push([{ engine: 'internal:text', selector: Tt(y.text, !1), score: jl - y.scoreBonus }]);
    }
    const p = { engine: 'css', selector: Ht(e.nodeName.toLowerCase()), score: zy };
    for (const y of u)
      s.push([
        p,
        { engine: 'internal:has-text', selector: Tt(y.text, !1), score: jl - y.scoreBonus },
      ]);
    if (c.length <= 80) {
      const y = new RegExp('^' + Bl(c) + '$');
      s.push([p, { engine: 'internal:has-text', selector: Tt(y, !1), score: km }]);
    }
  }
  const d = Ye(e);
  if (d && !['none', 'presentation'].includes(d)) {
    const p = Wi(e, !1);
    if (p) {
      const y = { engine: 'internal:role', selector: `${d}[name=${ht(p, !0)}]`, score: Bk };
      s.push([y]);
      for (const v of ys(p))
        s.push([
          {
      ...
      for (const v of u)
        s.push([
          y,
          { engine: 'internal:has-text', selector: Tt(v.text, !1), score: jl - v.scoreBonus },
        ]);
      if (c.length <= 80) {
        const v = new RegExp('^' + Bl(c) + '$');
        s.push([y, { engine: 'internal:has-text', selector: Tt(v, !1), score: km }]);
      }
    }
  }
  return Gu(s), s;
...
function Gu(t) {
  for (const e of t)
    for (const n of e)
      n.score > Dk && n.score < Vk && (n.score += Math.min(My, (n.selector.length / 10) | 0));
}
function Ml(t) {
  const e = [];
  let n = '';
...
function ys(t) {
  ...
  return (
    t.length <= 30
      ...
      : (e.push({ text: gl(t, 80), scoreBonus: 0 }), e.push({ text: gl(t, 30), scoreBonus: 1 })),
    (e = e.filter(n => n.text)),
...
function eE(t) {
  ...
  function s(y) {
    ...
    for (const E in (w = (m = y.parent) == null ? void 0 : m.type) == null ? void 0 : w.components)
      if (((_ = y.parent) == null ? void 0 : _.type.components[E]) === y.type) return n(y, E);
  ...
  function p(y) {
    return { name: s(y), children: c(y.subTree).map(p), rootElements: u(y), props: y.props };
  }
  return p(t);
}
function tE(t) {
    ...
    queryAll(t, e) {
      const n = t.ownerDocument || t,
        ...
        u = Wy(n)
          ...
          .map(p =>
            Vy(p, y => {
              if ((s && y.name !== s) || y.rootElements.some(v => !sa(t, v))) return !1;
...
class Ky {
  ...
  async _checkElementIsStable(e) {
    ...
    const c = () => {
      ...
      if (s) {
        if (!(_.x === s.x && _.y === s.y && _.width === s.width && _.height === s.height))
          return !1;
        ...
        y = v => {
          ...
          return (
            v.valueOrLabel !== void 0 &&
              (m = m && (v.valueOrLabel === p.value || v.valueOrLabel === p.label)),
    ...
    switch (iE.get(n)) {
        ...
        if (this._browserName === 'webkit') {
          const p = v => {
              ...
              m === void 0 &&
                ...
                (m =
                  v.clientX +
                  (((_ = this.document.scrollingElement) == null ? void 0 : _.scrollLeft) || 0));
              let w = v.pageY;
              return (
                w === void 0 &&
                  v.clientY !== void 0 &&
            ...
            y = v =>
              v instanceof TouchList || !v ? v : this.document.createTouchList(...v.map(p));
          l.target ?? (l.target = e),
      ...
      case 'deviceorientation':
        try {
          ...
          const { bubbles: p, cancelable: y, alpha: v, beta: m, gamma: w, absolute: _ } = l;
  ...
  previewNode(e) {
    ...
    if (e.nodeType !== Node.ELEMENT_NODE) return yl(`<${e.nodeName.toLowerCase()} />`);
    const n = e,
      s = [];
    for (let d = 0; d < n.attributes.length; d++) {
      const { name: p, value: y } = n.attributes[d];
      p !== 'style' && (!y && sE.has(p) ? s.push(` ${p}`) : s.push(` ${p}="${y}"`));
    }
    ...
    return yl(`<${n.nodeName.toLowerCase()}${o}>${qp(u, 50)}</${n.nodeName.toLowerCase()}>`);
  }
...
`)
  ...
  highlight(e) {
    this._highlight || ((this._highlight = new Su(this)), this._highlight.install()),
  ...
  _setupHitTargetInterceptors() {
    const e = s => {
      ...
      n = () => {
        for (const s of oE) this.window.addEventListener(s, e, { capture: !0, passive: !1 });
      };
  ...
  async expectSingleElement(e, n) {
    ...
    if (s === 'to.have.values') {
      ...
      return l.length !== n.expectedText.length
        ...
        : {
            received: l,
            matches: l.map((c, u) => new bu(n.expectedText[u]).matches(c)).every(Boolean),
          };
    }
    if (s === 'to.match.aria') {
    ...
    }
    {
      ...
      else if (s === 'to.have.text') l = n.useInnerText ? e.innerText : Ct(new Map(), e).full;
  ...
  expectArray(e, n) {
    ...
    if (
      (s === 'to.have.text.array' || s === 'to.contain.text.array'
        ? (o = e.map(l => (n.useInnerText ? l.innerText : Ct(new Map(), l).full)))
        : s === 'to.have.class.array' && (o = e.map(l => l.classList.toString())),
      o && n.expectedText)
    ) {
...
const iE = new Map([
  ...
  Xy = new Set(['pointerdown', 'pointerup', 'touchstart', 'touchend', 'touchcancel']),
  Gy = new Set([
    'mousedown',
    'mouseup',
    'pointerdown',
  ...
  return (
    ...
    s
      ? e
        ...
        : {
            matcher: l => (!t && !l.immediate.length ? !0 : l.immediate.some(c => gt(c) === t)),
            kind: 'strict',
          }
      : ((t = t.toLowerCase()),
...
class bu {
  ...
  normalize(e) {
    return (
      e &&
      (this._normalizeWhiteSpace && (e = gt(e)), this._ignoreCase && (e = e.toLocaleLowerCase()), e)
    );
  }
}
function Ju(t, e) {
...
class Tu {
    ...
    if (
      ...
      (this._hoveredModel.tooltipFooter = void 0),
        (this._hoveredModel.tooltipList = n.map(o =>
          this._recorder.injectedScript.utils.asLocator(this._recorder.state.language, o)
        )),
  ...
  onMouseMove(e) {
    ...
    if (this._hoveredElement) {
      const c = this._recorder.injectedScript.generateSelector(this._hoveredElement, {
      ...
      (o = c.selectors),
        (s = {
          ...
          tooltipFooter: o.length > 1 ? 'Click to select, right-click for more options' : void 0,
...
class cE {
  ...
  onMouseDown(e) {
    this._shouldIgnoreMouseEvent(e) ||
      (this._performingActions.size || Me(e), (this._activeModel = this._hoveredModel));
  }
  onMouseUp(e) {
    this._shouldIgnoreMouseEvent(e) || this._performingActions.size || Me(e);
  }
  ...
  _shouldGenerateKeyPressFor(e) {
    ...
    return e.key.length === 1 && !n ? !!Lu(this._recorder.deepEventTarget(e)) : !0;
  }
  _updateModelForHoveredElement() {
    ...
    (this._hoveredModel && this._hoveredModel.selector === e) ||
      ((this._hoveredModel = e ? { selector: e, elements: n, color: '#dc6f6f7f' } : null),
      this._recorder.updateHighlight(this._hoveredModel, !0));
  }
}
class Nu {
  ...
  _generateAction() {
    ...
    if (this._kind === 'value') {
      ...
      return this._kind === 'snapshot'
        ? ((this._hoverHighlight = this._recorder.injectedScript.generateSelector(e, {
            testIdAttributeName: this._recorder.state.testIdAttributeName,
            forTextExpect: !0,
          })),
...
class fE {
  ...
  installListeners() {
    ...
    let e;
    const n = () => {
      this.highlight.install(), (e = this.injectedScript.builtinSetTimeout(n, 500));
    };
  ...
  setUIState(e, n) {
    ...
    if (e.actionSelector !== this._lastHighlightedSelector) {
      const c = e.actionSelector ? pE(this.injectedScript, e.actionSelector, this.document) : null;
    ...
    s === 'clear' ? this.clearHighlight() : s !== 'noop' && this._updateHighlight(s, !1);
  }
  clearHighlight() {
...
const Oi = Symbol('selector'),
  _E = class Fi {
    constructor(e, n, s) {
      if (
        (s != null && s.hasText && (n += ` >> internal:has-text=${Tt(s.hasText, !1)}`),
        s != null && s.hasNotText && (n += ` >> internal:has-not-text=${Tt(s.hasNotText, !1)}`),
        s != null && s.has && (n += ' >> internal:has=' + JSON.stringify(s.has[Oi])),
        s != null && s.hasNot && (n += ' >> internal:has-not=' + JSON.stringify(s.hasNot[Oi])),
      ...
      (l.locator = (c, u) => new Fi(e, o ? o + ' >> ' + c : c, u)),
        (l.getByTestId = c =>
          l.locator(mE(e.testIdAttributeNameForStrictErrorAndConsoleCodegen(), c))),
        ...
        (l.and = c => new Fi(e, o + ' >> internal:and=' + JSON.stringify(c[Oi]))),
        (l.or = c => new Fi(e, o + ' >> internal:or=' + JSON.stringify(c[Oi])));
    }
  };
let kE = _E;
class EE {
...
async function oa(t, e) {
  const n = nv(e);
  Or(t)
    ? (await ws(null, t.contents, n, Object.freeze([t]))) === dn && (t.contents = null)
...
class la extends If {
  ...
  toString(e, n, s) {
    const o = `*${this.source}`;
    if (e) {
      if ((iv(this.source), e.options.verifyAliasOrder && !e.anchors.has(this.source))) {
...
function Ki(t, e, n) {
  ...
  if (Oe(t)) {
    const _ = (m = (v = n.schema[rr]).createNode) == null ? void 0 : m.call(v, n.schema, null, n);
  ...
  if (s && t && typeof t == 'object') {
    if (((d = u.get(t)), d)) return d.anchor || (d.anchor = o(t)), new la(d.anchor);
...
const zi = t => t == null || (typeof t == 'object' && !!t[Symbol.iterator]().next().done);
class cv extends If {
  constructor(e, n) {
    super(e),
  ...
  getIn(e, n) {
    const [s, ...o] = e,
      l = this.get(s, !0);
    return o.length === 0 ? (!n && be(l) ? l.value : l) : Re(l) ? l.getIn(o, n) : void 0;
  }
  hasAllNullValues(e) {
    return this.items.every(n => {
      ...
      const s = n.value;
      return (
        s == null || (e && be(s) && s.value == null && !s.commentBefore && !s.comment && !s.tag)
      );
    });
  }
  hasIn(e) {
...
`
      ...
      n === Zu && (S = Mm(t, S, e.length)), (v = S + e.length + d), (m = void 0);
    else {
      if (
        O === ' ' &&
        w &&
...
` &&
  ...
  const _ = w.indexOf(`
`);
  _ === -1 ? (v = '-') : n === w || _ !== w.length - 1 ? ((v = '+'), l && l()) : (v = ''),
    w &&
...
function RE(t, e, n, s) {
  const { type: o, value: l } = t,
    { actualString: c, implicitKey: u, indent: d, indentStep: p, inFlow: y } = e;
  if (
    (u &&
      l.includes(`
`)) ||
...
function Ji(t, e, n, s) {
  ...
  if (p === null) {
    const { defaultKeyType: y, defaultStringType: v } = e.options,
      m = (o && y) || v;
    if (((p = d(m)), p === null)) throw new Error(`Unsupported default string type ${m}`);
  }
  return p;
}
function fv(t, e) {
...
function zE({ key: t, value: e }, n, s, o) {
  ...
  let w =
    ...
    (!t ||
      (m && e == null && !n.inFlow) ||
      Re(t) ||
      (be(t) ? t.type === he.BLOCK_FOLDED || t.type === he.BLOCK_LITERAL : typeof t == 'object'));
  ...
  if (n.inFlow) {
    ...
    return (E = `? ${E}`), m && !_ ? (E += br(E, n.indent, p(m))) : S && o && o(), E;
  _ && (m = null),
    w
...
`) &&
  ...
  return (
    (E += F + D),
    n.inFlow ? R && s && s() : O && !R ? (E += br(E, n.indent, p(O))) : S && o && o(),
    E
  );
}
function dv(t, e) {
...
const wl = '<<',
  ...
  BE = (t, e) =>
    (An.identify(e) || (be(e) && (!e.type || e.type === he.PLAIN) && An.identify(e.value))) &&
    (t == null ? void 0 : t.doc.schema.tags.some(n => n.tag === An.tag && n.default));
function hv(t, e, n) {
  if (((n = t && Mr(n) ? n.resolve(t.doc) : n), Ps(n))) for (const s of n.items) ju(t, e, s);
...
class at {
  constructor(e, n = null) {
    Object.defineProperty(this, Wt, { value: ev }), (this.key = e), (this.value = n);
  }
  clone(e) {
...
function HE(
  ...
  for (let _ = 0; _ < e.length; ++_) {
    ...
    let E = null;
    if (De(S))
      !v && S.spaceBefore && m.push(''), Xl(n, m, S.commentBefore, v), S.comment && (E = S.comment);
    else if (Oe(S)) {
...
function qE({ items: t }, e, { flowChars: n, itemIndent: s }) {
  ...
  for (let _ = 0; _ < t.length; ++_) {
    ...
    let E = null;
    if (De(S))
      S.spaceBefore && v.push(''), Xl(e, v, S.commentBefore, !1), S.comment && (E = S.comment);
    else if (Oe(S)) {
      const C = De(S.key) ? S.key : null;
      C && (C.spaceBefore && v.push(''), Xl(e, v, C.commentBefore, !1), C.comment && (p = !0));
...
function Tr(t, e) {
  ...
  for (const s of t)
    if (Oe(s) && (s.key === e || s.key === n || (be(s.key) && s.key.value === n))) return s;
}
class Ot extends cv {
  static get tagName() {
  ...
  add(e, n) {
    ...
    if (o) {
      ...
      be(o.value) && av(s.value) ? (o.value.value = s.value) : (o.value = s.value);
    } else if (l) {
...
const gv = {
  ...
  Of = (t, e, n, { intAsBigInt: s }) => (s ? BigInt(t) : parseInt(t.substring(e), n));
function wv(t, e, n) {
  const { value: s } = t;
...
class ks extends ir {
  ...
  toJSON(e, n) {
    ...
    for (const o of this.items) {
      let l, c;
      if (
        (Oe(o) ? ((l = qt(o.key, '', n)), (c = qt(o.value, l, n))) : (l = qt(o, '', n)), s.has(l))
      )
...
function bv({ value: t, source: e }, n) {
  return e && (t ? Tv : Nv).test.test(e) ? e : t ? n.options.trueStr : n.options.falseStr;
}
const Tv = {
    identify: t => t === !0,
    default: !0,
...
class Es extends Ot {
  ...
  static from(e, n, s) {
    ...
    if (n && Symbol.iterator in Object(n))
      for (let c of n)
        typeof o == 'function' && (c = o.call(n, c, c)), l.items.push(jf(c, null, s));
    return l;
  }
}
...
const Av = {
  ...
  $m = [Rs, Ds, fa, da, Tv, Nv, YE, ZE, eb, tb, XE, GE, JE, $f, An, Rf, Pf, Ff, Av, Lv, ma],
  Pm = new Map([
    ['core', VE],
    ['failsafe', [Rs, Ds, fa]],
    ['json', QE],
...
class ga {
  ...
  clone() {
    const e = Object.create(ga.prototype, Object.getOwnPropertyDescriptors(this));
...
class Fs {
  ...
  clone() {
    ...
    return (
      ...
      (e.contents = De(this.contents) ? this.contents.clone(e.schema) : this.contents),
  ...
  createNode(e, n, s) {
    ...
    if (typeof n == 'function') (e = n.call({ '': e }, '', e)), (o = n);
      ...
      const E = C => typeof C == 'number' || C instanceof String || C instanceof Number,
  ...
  hasIn(e) {
    return zi(e) ? this.contents !== void 0 : Re(this.contents) ? this.contents.hasIn(e) : !1;
  }
  set(e, n) {
    this.contents == null
  ...
  toJS({ json: e, jsonArg: n, mapAsMap: s, maxAliasCount: o, onAnchor: l, reviver: c } = {}) {
    ...
    if (typeof l == 'function') for (const { count: p, res: y } of u.anchors.values()) l(y, p);
...
function As(
  ...
  for (const B of t)
    switch (
      ...
      case 'comma':
        if (e) {
          O && l(B, 'UNEXPECTED_TOKEN', `Unexpected , in ${e}`), (O = B), (p = !1), (y = !1);
          break;
        }
      default:
        l(B, 'UNEXPECTED_TOKEN', `Unexpected ${B.type} token`), (p = !1), (y = !1);
    }
...
function jv(t, e, n) {
  ...
  if (s === !1) return !1;
  const o =
    typeof s == 'function' ? s : (l, c) => l === c || (be(l) && be(c) && l.value === c.value);
...
` + E.comment)
    ...
    } else ((y = E.found) == null ? void 0 : y.indent) !== s.indent && o(d, 'BAD_INDENT', Dm);
    n.atKey = !0;
    const C = E.end,
...
` + F.comment)
    ...
    if (E === 0) F.comma && o(F.comma, 'UNEXPECTED_TOKEN', `Unexpected , in ${u}`);
...
` + U)
    ...
    if (!c && !R && !F.found) {
      ...
      p.items.push(U), (v = U.range[2]), $u(D) && o(U.range, 'BLOCK_IN_FLOW', Ou);
    } else {
      n.atKey = !0;
      const U = F.end,
...
` + j.comment)
      ...
      if ((n.options.keepSourceTokens && (W.srcToken = T), c)) {
        const z = p;
        jv(n, z.items, B) && o(U, 'DUPLICATE_KEY', 'Map keys must be unique'), z.items.push(W);
      } else {
  ...
  if (w && w.source === m) S = w.offset + w.source.length;
    ...
    o(v, y ? 'MISSING_CHAR' : 'BAD_INDENT', T), w && w.source.length !== 1 && _.unshift(w);
  }
  if (_.length > 0) {
...
function ab(t, e, n, s, o) {
  ...
  const p = Pu(t, e, n, o, c, d),
    ...
    v = De(y) ? y : new he(y);
  return (v.range = p.range), (v.tag = c), d != null && d.format && (v.format = d.format), v;
}
function Mv(t, e, n) {
  const s = e.offset,
...
`.repeat(Math.max(1, c.length - 1))
  ...
  for (let S = 0; S < u; ++S) {
    const [E, T] = c[S];
    if (T === '' || T === '\r') o.indent === 0 && E.length > d && (d = E.length);
    else {
      E.length < d &&
        n(
          p + E.length,
...
function fb(t, e) {
  ...
  return n && e(0, 'BAD_SCALAR_START', `Plain value cannot start with ${n}`), $v(t);
}
function db(t, e) {
  return (
...
function Pv(t, e, n, s) {
  ...
  let y;
  try {
    const v = p.resolve(o, m => s(n ?? e, 'TAG_RESOLVE_FAILED', m), t.options);
    y = be(v) ? v : new he(v);
  } catch (v) {
...
function yb(t, e, n, s, o) {
  ...
  return c && !c.collection
    ...
    : (o(s, 'TAG_RESOLVE_FAILED', `Unresolved tag: ${n}`, n !== 'tag:yaml.org,2002:str'), t[hn]);
}
...
function Rv(t, e, n, s) {
  ...
  switch (e.type) {
    ...
    default: {
      ...
      s(e, 'UNEXPECTED_TOKEN', v), (p = Uf(t, e.offset, void 0, null, n, s)), (y = !1);
    }
  }
  return (
    ...
    o &&
      ...
      (!be(p) || typeof p.value != 'string' || (p.tag && p.tag !== 'tag:yaml.org,2002:str')) &&
...
function Uf(t, e, n, s, { spaceBefore: o, comment: l, anchor: c, tag: u, end: d }, p) {
  ...
  constructor(e = {}) {
    (this.doc = null),
      ...
      (this.onError = (n, s, o, l) => {
        const c = $i(n);
        l ? this.warnings.push(new Iv(c, s, o)) : this.errors.push(new Nr(c, s, o));
      }),
  ...
  *next(e) {
    switch (e.type) {
      ...
      case 'doc-end': {
        ...
        const n = Zi(e.end, e.offset + e.source.length, this.doc.options.strict, this.onError);
...
${n.comment}`
      ...
      default:
        this.errors.push(new Nr($i(e), 'UNEXPECTED_TOKEN', `Unsupported token ${e.type}`));
    }
  }
  *end(e = !1, n = -1) {
...
const zm = new Set('0123456789ABCDEFabcdef'),
  Mb = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"),
  _l = new Set(',[]{}'),
  Ob = new Set(` ,[]{}
\r	`),
  Du = t => !t || Ob.has(t);
...
`,
  ...
  *parseStream() {
    ...
    if ((e[0] === ya && (yield* this.pushCount(1), (e = e.substring(1))), e[0] === '%')) {
      let n = e.length,
        s = e.indexOf('#');
      for (; s !== -1; ) {
        const l = e[s - 1];
  ...
  *parseFlowCollection() {
    ...
    if (
      ((s !== -1 && s < this.indentNext && o[0] !== '#') ||
        (s === 0 && (o.startsWith('---') || o.startsWith('...')) && tn(o[3]))) &&
...
` &&
    ...
    return yield Xi, yield* this.pushToIndex(e + 1, !0), yield* this.parseLineStart();
  }
  *parsePlainScalar() {
  ...
  *pushTag() {
    if (this.charAt(1) === '<') {
      ...
      for (; n; )
        ...
        else if (n === '%' && zm.has(this.buffer[e + 1]) && zm.has(this.buffer[e + 2]))
          n = this.buffer[(e += 3)];
        else break;
...
function Vv(t) {
  ...
  return { lineCounter: t.lineCounter || (e && new Hv()) || null, prettyErrors: e };
}
function $b(t, e = {}) {
  ...
  if (s && n) for (const u of c) u.errors.forEach(Gl(t, n)), u.warnings.forEach(Gl(t, n));
...
function Wv(t, e = {}) {
  ...
  return s && n && (c.errors.forEach(Gl(t, n)), c.warnings.forEach(Gl(t, n))), c;
}
function Pb(t, e, n) {
  let s;
  ...
  const o = Wv(t, n);
  if (!o) return null;
  if ((o.warnings.forEach(l => dv(o.options.logLevel, l)), o.errors.length > 0)) {
        ...
        x.jsxs(df, {
          children: [
            ...
            ['action', 'before', 'after'].map(w =>
              x.jsx(Qg, { id: w, title: Bb(w), selected: u === w, onSelect: () => d(w) }, w)
            ),
        ...
        (async () => {
          ...
          if (S) {
            ...
            try {
              ...
              S.contentWindow ? S.contentWindow.location.replace(C) : (S.src = C), await T;
            } catch {
            } finally {
              S.removeEventListener('load', E), S.removeEventListener('error', E);
            }
          }
            ...
            children: x.jsxs('div', {
              ...
              children: [
                x.jsx('iframe', {
                  ...
                  name: 'snapshot',
                  title: 'DOM Snapshot',
                  className: ze(v.current.visibleIframe === 0 && 'snapshot-visible'),
                }),
                x.jsx('iframe', {
                  ref: d,
                  name: 'snapshot',
                  title: 'DOM Snapshot',
                  className: ze(v.current.visibleIframe === 1 && 'snapshot-visible'),
                }),
              ],
            }),
          }),
...
const Hm = ({
  ...
  P.useEffect(() => {
    ...
    const p = o.lastEdited === 'ariaSnapshot' && o.ariaSnapshot ? hf(Kv, o.ariaSnapshot) : void 0,
      y = o.lastEdited === 'locator' && o.locator ? TE(n, o.locator, s) : void 0;
      ...
      v.setUIState(
        ...
        },
        {
          async elementPicked(S) {
            l({ locator: nr(n, m + S.selector), ariaSnapshot: S.ariaSnapshot, lastEdited: 'none' });
          },
          highlightUpdated() {
...
function Ub(t) {
  ...
  const s = t.afterSnapshot ? { action: t, snapshotName: t.afterSnapshot } : e,
    o = t.inputSnapshot ? { action: t, snapshotName: t.inputSnapshot, hasInputTarget: !0 } : s;
...
function Xb(t, e, n, s, o) {
  return Vm(
    async () => {
      ...
      d ||
        ((d = {
          errors: ((w = o == null ? void 0 : o.source) == null ? void 0 : w.errors) || [],
          content: (_ = o == null ? void 0 : o.source) == null ? void 0 : _.content,
        }),
        n.set(u, d));
      const p = c ? o : l,
        y = c
          ? (o == null ? void 0 : o.line) || ((S = d.errors[0]) == null ? void 0 : S.line) || 0
          : l.line,
        v = s && u.startsWith(s) ? u.substring(s.length + 1) : u,
        m = d.errors.map(T => ({ type: 'error', line: T.line, message: T.message }));
      if (
        (m.push({ line: y, type: 'running' }),
        ((E = o == null ? void 0 : o.source) == null ? void 0 : E.content) !== void 0)
      )
      ...
      return { source: d, highlight: m, targetLine: y, fileName: v, location: p };
    },
    [t, e, s, o],
...
const Gb = ({
  ...
  const { source: y, highlight: v, targetLine: m, fileName: w, location: _ } = Xb(t, d, e, n, s),
    S = P.useCallback(() => {
      _ && (l ? l(_) : (window.location.href = `vscode://file//${_.file}:${_.line}`));
    }, [l, _]),
        ...
        w &&
          x.jsxs(df, {
            children: [
              ...
              _ && x.jsx(Vt, { icon: 'link-external', title: 'Open in VS Code', onClick: S }),
            ],
          }),
        x.jsx(Ns, {
          text: y.content || '',
...
const Gv = { width: 200, height: 45 },
      ...
      children: [
        ...
        (n == null ? void 0 : n.x) !== void 0 &&
          x.jsxs('div', {
            ...
            children: [
              n.action &&
                x.jsx('div', { className: 'film-strip-hover-title', children: af(n.action, n) }),
              d &&
                p &&
                x.jsx('div', {
  ...
  tT = ({ boundaries: t, page: e, width: n }) => {
    ...
    for (const S of o)
      (s.width = Math.max(s.width, S.width)), (s.height = Math.max(s.height, S.height));
    const l = Yv(s, Gv),
      c = o[0].timestamp,
  ...
  const R = P.useCallback(
    ...
    D = P.useCallback(
      Q => {
        ...
        Ee !== Ce && d({ minimum: Math.min(Ee, Ce), maximum: Math.max(Ee, Ce) });
      },
      [e, m, y, t, s, v, d]
    ),
    F = P.useCallback(() => {
...
const iT = ({ model: t }) => {
            ...
            x.jsxs(
              'div',
              {
                ...
                children: [
                  ...
                  e.description && x.jsxs('span', { children: [': ', Wg(e.description)] }),
                ],
              },
              `annotation-${n}`
            )
  ...
  gT = ({
    ...
    const fe = P.useMemo(() => {
        if (v) {
          const yt = t == null ? void 0 : t.actions.find(Kt => Kt.callId === v);
          if (yt) return yt;
        }
    ...
    const Ln = e_(t, Ee),
      ...
      Bs = { id: 'log', title: 'Log', render: () => x.jsx(mx, { action: ue, isLive: o }) },
      no = {
        id: 'errors',
        title: 'Errors',
      ...
      In = {
        ...
        render: () =>
          x.jsx(t_, {
            ...
            boundaries: Pr,
            selectedTime: Ee,
            onAccepted: le => Ce({ minimum: le.timestamp, maximum: le.timestamp }),
            onEntryHovered: F,
          }),
      },
      Us = {
    ...
    const Hs = {
            ...
            c &&
              x.jsxs('div', {
                ...
                children: [
                  ...
                  x.jsx('div', { className: 'workbench-run-duration', children: lr ? mt(lr) : '' }),
                ],
              }),
            x.jsx(ox, {
              sdkLanguage: sn,
      ...
      Rr = { id: 'metadata', title: 'Metadata', component: x.jsx(iT, { model: t }) };
    return x.jsxs('div', {
      ...
      children: [
        ...
        x.jsx(Fl, {
          ...
          main: x.jsx(Fl, {
            ...
            sidebar: x.jsx(Wu, { tabs: [Hs, Rr], selectedTab: U, setSelectedTab: B }),
          }),
          sidebar: x.jsx(Wu, {
            tabs: jn,
            selectedTab: j,
