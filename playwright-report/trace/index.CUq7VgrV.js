...
const I = ({
    ...
    return (
      ...
      s &&
        e.jsx('dialog', { ref: m, style: y, className: r, 'data-testid': b, open: !0, children: L })
    );
  },
  V = (r, c) => {
    const s = R(r, c, 'left');
  ...
  $ = () => {
    ...
    return e.jsxs(e.Fragment, {
      children: [
        e.jsx(W, { ref: r, icon: 'settings-gear', title: 'Settings', onClick: () => s(i => !i) }),
        e.jsx(I, {
    ...
    n.useEffect(() => {
      const t = async o => {
        ...
        if ((l = o.clipboardData) != null && l.files.length) {
          for (const a of o.clipboardData.files) if (a.type !== 'application/zip') return;
